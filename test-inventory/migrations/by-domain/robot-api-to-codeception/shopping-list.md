...
|---|---|---|---|---|---|---|
| [ ] | Add_aconfigurable_product_with_missing_availableQuantity_value_of_to_the_shopping_list | b2b | `DELETE /shopping-lists/$` → 201 | — | M | — |
...
| [ ] | Add_a_configurable_product_to_the_shopping_list_with_missing_price | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_empty_availableQuantity_value_of_to_the_shopping_list | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_empty_price_value_of_to_the_shopping_list | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_empty_quantity_value_of_to_the_shopping_list | ×2 | `POST /shopping-lists/$` → 201 | — | M | — |
...
| [ ] | Add_a_configurable_product_with_missing_isComplete_value_of_to_the_shopping_list | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_missing_quantity_to_the_shopping_list | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_negative_price_value_of_to_the_shopping_list | ×2 | `POST /shopping-lists/$` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_negative_quantity_to_the_shopping_list | ×2 | `POST /shopping-lists` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_numeric_isComplete_value_of_to_the_shopping_list | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_string_isComplete_value_of_to_the_shopping_list | ×2 | `POST /sho` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_string_quantity_to_the_shopping_list | ×2 | `POST /shopping-lists` → 201 | — | M | — |
| [ ] | Add_a_configurable_product_with_zero_quantity_to_the_shopping_list | ×2 | `POST /shopping-lists` → 201 | — | M | — |
| [ ] | Add_a_non-configurable_product_to_the_shopping_list_with_configuration | ×2 | `POST /shopping-lists/$` → 201 | — | M | — |
| [ ] | Add_a_non-configurable_product_to_the_shopping_list_with_configuration_and_configurable_product | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
...
| [ ] | Add_aconfigurable_product_with_string_availableQuantity_value_of_to_the_shopping_list | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
...
| [ ] | Add_2_Configurable_products_but_with_different_configurations | ×2 | `GET /shopping-lists/$` → 201 | — | M | — |
| [ ] | Add_Configurable_products_and_regular_product | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
...
| [ ] | Add_a_configurable_product_to_the_shopping_list | ×2 | `POST /shopping-lists` → 201 | — | M | — |
...
| [ ] | Change_preferred_date_of_the_configurable_product_in_the_shopping_list | ×2 | `POST /shopping-lists/$` → 201 | — | M | — |
| [ ] | Change_preferred_time_of_the_day_of_the_configurable_product_in_the_shopping_list | ×2 | `POST /shopping-lists` → 201 | — | M | — |
...
| [ ] | Change_the_quantity_of_the_Configured_Product_so_Volume_price_is_applied | ×2 | `POST /shopping-lists/$` → 201 | — | M | — |
...
| [ ] | Remove_a_configurable_product_from_the_shopping_list | ×2 | `POST /shopping-lists/$` → 201 | — | M | — |
| [ ] | Remove_a_configurable_product_from_the_shopping_list_and_leave_a_regular_product | ×2 | `DELETE /shopping-lists/$` → 201 | — | M | — |
| [ ] | Set_configuration_for_the_configurable_product_in_the_shopping_list | ×2 | `POST /shopping-lists` → 201 | — | M | — |
