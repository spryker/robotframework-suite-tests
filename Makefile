...
test_api_b2b:
	robot -v env:$(ENV_API_B2B) -v glue_env:${glue_env} -v bapi_env:${bapi_env} -v sapi_env:${sapi_env} --exclude skip-due-to-issueORskip-due-to-refactoring -d results -s tests.api.b2b .

test_api_b2c:
	robot -v env:$(ENV_API_B2C) -v glue_env:${glue_env} -v bapi_env:${bapi_env} -v sapi_env:${sapi_env} --exclude skip-due-to-issueORskip-due-to-refactoring -d results -s tests.api.b2c .

test_api_mp_b2c:
	robot -v env:$(ENV_API_MP_B2C) -v glue_env:${glue_env} -v bapi_env:${bapi_env} -v sapi_env:${sapi_env} --exclude skip-due-to-issueORskip-due-to-refactoring -d results -s tests.api.mp_b2c .

test_api_mp_b2b:
	robot -v env:$(ENV_API_MP_B2B) -v glue_env:${glue_env} -v bapi_env:${bapi_env} -v sapi_env:${sapi_env} --exclude skip-due-to-issueORskip-due-to-refactoring -d results -s tests.api.mp_b2b .

test_api_suite:
	robot -v env:$(ENV_API_SUITE) -v glue_env:${glue_env} -v bapi_env:${bapi_env} -v sapi_env:${sapi_env} --exclude skip-due-to-issueORskip-due-to-refactoring -d results -s tests.api.suite .
