...
${quote_request_revise_button}    xpath=//*[contains(text(),'Revise')]
${quote_request_convert_to_cart_button}    xpath=//*[contains(text(),'Convert to Cart')]
...
${quote_request_edit_items_button}    xpath=//*[contains(text(),'Edit Items')]
${quote_request_save_button}    xpath=//button[@name='save']
${quote_request_save_and_back_to_edit_button}    xpath=//button[@name='saveAndBack']
