...
Zed: Check checkbox by Label:
    ...
    wait until element is visible    xpath=//input[@type='checkbox'][following-sibling::label[contains(text(), '${checkbox_label}')]]
    Check checkbox    xpath=//input[@type='checkbox'][following-sibling::label[contains(text(), '${checkbox_label}')]]
...
Zed: Uncheck Checkbox by Label:
    [Arguments]    ${checkbox_label}
    wait until element is visible    xpath=//input[@type='checkbox'][following-sibling::label[contains(text(), '${checkbox_label}')]]
    Uncheck Checkbox    xpath=//input[@type='checkbox'][following-sibling::label[contains(text(), '${checkbox_label}')]]
