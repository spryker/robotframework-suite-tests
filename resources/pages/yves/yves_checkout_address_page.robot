...
&{checkout_address_billing_selector}    b2c=xpath=//select[@id='addressesForm_billingAddress_id_customer_address']    b2b=xpath=//select[contains(@class,'form-select-billingAddress')]
