...
${price_mode_switcher_net_prices}    xpath=//span[contains(@class,'select2-dropdown')]//li[contains(@id,'NET_MODE')]
${price_mode_switcher_gross_prices}    xpath=//span[contains(@class,'select2-dropdown')]//li[contains(@id,'GROSS_MODE')]
