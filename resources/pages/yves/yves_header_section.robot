*** Variables ***
&{header_login_button}    b2b=xpath=//a[contains(@class,'button') and contains(@class,'header__login')]    b2c=xpath=//a[contains(@class,'button') and contains(@class,'header__login')]    suite-nonsplit=xpath=//header//*[@class='menu__item']//a[contains(@href,'/login')]    mp_b2b=xpath=//a[contains(@class,'button') and contains(@class,'header__login')]    mp_b2c=xpath=//a[contains(@class,'button') and contains(@class,'header__login')]
${user_navigation_menu_login_button}    xpath=//a[@class='user-block__button button col' and contains(text(),'Login')]
&{user_navigation_icon_header_menu_item}    b2b=xpath=//div[contains(@class,'user-navigation__user-name')]    b2c=xpath=//nav[@data-qa='component navigation-top']//*[@*='user-account']    suite-nonsplit=xpath=//header//a[contains(@href,'/customer/overview')]    mp_b2b=xpath=//div[contains(@class,'user-navigation__user-name')]    mp_b2c=xpath=//nav[@data-qa='component navigation-top']//*[@*='user-account']
&{user_navigation_fly_out_header_menu_item}    b2b=xpath=//li[contains(@class,'user-navigation__item--user')]//nav[contains(@class,'user-navigation__sub-nav')]//ul[contains(@class,'list--secondary')]    b2c=xpath=//div[contains(@class,'user-block js-nav-overlay__drop-down-block')]    mp_b2b=xpath=//li[contains(@class,'user-navigation__item--user')]//nav[contains(@class,'user-navigation__sub-nav')]//ul[contains(@class,'list--secondary')]    mp_b2c=xpath=//div[contains(@class,'user-block js-nav-overlay__drop-down-block')]
...
&{currency_switcher_header_menu_item}    b2b=xpath=//*[@data-qa='component navigation-top']//select[@name='currency-iso-code']    b2c=xpath=//div[@class='header__select']//select[@name='currency-iso-code']    mp_b2b=xpath=//*[@data-qa='component navigation-top']//select[@name='currency-iso-code']    mp_b2c=xpath=//div[@class='header__select']//select[@name='currency-iso-code']
...
&{shopping_car_icon_header_menu_item}    b2b=xpath=//*[contains(@class,'icon--cart')]/ancestor::a    b2c=xpath=//cart-counter[contains(@class,'navigation-top')]    suite-nonsplit=xpath=//header//cart-counter//a[contains(@href,'/cart')]    mp_b2b=xpath=//*[contains(@class,'icon--cart')]/ancestor::a    mp_b2c=xpath=//cart-counter[contains(@class,'navigation-top')]
