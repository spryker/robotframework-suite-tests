*** Variable ***
&{pdp_main_container_locator}    ui_b2b=xpath=//main[contains(@class,'page-layout-main--pdp')]    ui_b2c=xpath=//*[@itemtype='https://schema.org/Product']//product-carousel[contains(@*, 'pdp')]    ui_suite=xpath=//image-carousel[contains(@class,'js-image-carousel')]    ui_mp_b2b=xpath=//main[contains(@class,'page-layout-main--pdp')]    ui_mp_b2c=xpath=//*[@itemtype='https://schema.org/Product']//product-carousel[contains(@*, 'pdp')]
...
&{pdp_add_to_cart_disabled_button}    ui_b2c=xpath=//button[@disabled and contains(text(),'Add to Cart')]    ui_b2b=xpath=//button[@disabled and contains(@data-qa,'add-to-cart-button')]    ui_mp_b2b=xpath=//button[@disabled and contains(@data-qa,'add-to-cart-button')]    ui_mp_b2c=xpath=//button[@disabled and contains(text(),'Add to Cart')]    ui_mp_b2c=xpath=//button[@disabled and contains(text(),'Add to Cart')]
...
&{pdp_alternative_products_slider}    ui_b2b=xpath=//*[@data-qa='component product-alternative-slider']    ui_b2c=xpath=//*[contains(@class,'product-slider')][contains(.,'Alternative products')]/../slick-carousel    ui_mp_b2b=xpath=//*[@data-qa='component product-alternative-slider']    ui_mp_b2c=xpath=//*[contains(@class,'product-slider')][contains(.,'Alternative products')]/../slick-carousel
...
&{pdp_sales_label}    ui_b2b=xpath=//*[@class='page-info']//*[@data-qa='component label-group']//span[contains(text(),'SALE')]    ui_b2c=xpath=//product-carousel//*[@data-qa='component label-group']//span[contains(text(),'SALE')]    ui_mp_b2b=xpath=//*[@class='page-info']//*[@data-qa='component label-group']//span[contains(text(),'SALE')]    ui_mp_b2c=xpath=//product-carousel//*[@data-qa='component label-group']//span[contains(text(),'SALE')]
&{pdp_new_label}    ui_b2b=xpath=//*[@class='page-info']//*[@data-qa='component label-group']//span[contains(text(),'New')]    ui_b2c=xpath=//product-carousel//*[@data-qa='component label-group']//span[contains(text(),'New')]    ui_mp_b2b=xpath=//*[@class='page-info']//*[@data-qa='component label-group']//span[contains(text(),'New')]    ui_mp_b2c=xpath=//product-carousel//*[@data-qa='component label-group']//span[contains(text(),'New')]
