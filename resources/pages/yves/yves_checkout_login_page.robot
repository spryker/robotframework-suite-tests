...
${yves_checkout_signup_button}    xpath=//toggler-radio[@data-qa='component toggler-radio checkoutProceedAs register']//label[@class='toggler-radio__container']
...
${yves_checkout_login_tab}    xpath=//toggler-radio[@data-qa='component toggler-radio checkoutProceedAs login']//label[@class='toggler-radio__container']