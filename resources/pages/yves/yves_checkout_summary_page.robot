...
&{submit_checkout_form_button}    b2b=xpath=//div[contains(@class,'form--checkout-form')]//button[@data-qa='submit-button']    b2c=xpath=//div[contains(@class,'form--checkout-form')]//button[@data-qa='submit-button']    suite-nonsplit=xpath=//button[@data-qa='submit-button']    mp_b2b=xpath=//div[contains(@class,'form--checkout-form')]//button[@data-qa='submit-button']    mp_b2c=xpath=//div[contains(@class,'form--checkout-form')]//button[@data-qa='submit-button']
&{checkout_summary_surcharge_amount}    b2c=xpath=//ul[@data-qa='component summary-overview']//li[contains(text(),'Surcharge')]//span    b2b=xpath=//div[@data-qa='component summary-overview']//li//div[contains(text(),'Surcharge')]/following-sibling::div    mp_b2b=xpath=//div[@data-qa='component summary-overview']//li//div[contains(text(),'Surcharge')]/following-sibling::div    mp_b2c=xpath=//ul[@data-qa='component summary-overview']//li[contains(text(),'Surcharge')]//span
&{checkout_summary_alert_message}    b2c=xpath=//div[contains(@class,'checkout-actions')]//ul[contains(@class,'alert')]/li    b2b=xpath=//div[@data-qa='component form']//ul[contains(@class,'alert')]/li    mp_b2b=xpath=//div[@data-qa='component form']//ul[contains(@class,'alert')]/li    mp_b2c=xpath=//div[contains(@class,'checkout-actions')]//ul[contains(@class,'alert')]/li
