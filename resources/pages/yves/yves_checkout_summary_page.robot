...
${checkout_summary_surcharge_amount}    xpath=//ul[@data-qa='component summary-overview']//li[contains(text(),'Surcharge')]//span
${checkout_summary_alert_message}    xpath=//div[contains(@class,'checkout-actions')]//ul[contains(@class,'alert')]/li