...
&{catalog_products_counter_locator}    ui_b2b=xpath=//*[contains(@class,'col--counter')]    ui_b2c=xpath=//*[contains(@class,'sort__results col')]    ui_mp_b2b=xpath=//*[contains(@class,'catalog-header__count')]    ui_mp_b2c=xpath=//*[contains(@class,'sort__results col')]    ui_suite=xpath=//*[@data-qa='component sort']//strong
${catalog_empty_state_locator}    xpath=//*[@data-qa='component empty-catalog-state']
