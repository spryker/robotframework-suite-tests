*** Variable ***
&{catalog_main_page_locator}    b2b=xpath=//main[contains(@class,'page-layout-main--catalog-page')]    b2c=xpath=//div[contains(@class,'catalog-right')]    suite-nonsplit=xpath=//form[contains(@class,'catalog__form')]
