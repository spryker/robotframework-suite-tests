...
&{quick_order_shopping_list_visible}    ui_mp_b2b=css=custom-select:has([name=idShoppingList])    ui_b2b=css=*[name=idShoppingList]    ui_suite=css=*[name=idShoppingList]    ui_b2c=css=*[name=idShoppingList]    ui_mp_b2c=css=*[name=idShoppingList]
