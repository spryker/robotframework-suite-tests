...
${quick_order_row_merchant_selector}    xpath=//div[contains(@data-qa,'component quick-order-rows')]//input[contains(@class,'autocomplete')][@value='']/ancestor::quick-order-row//select[@id='quick_order_item_embedded_form_product_offer_reference']