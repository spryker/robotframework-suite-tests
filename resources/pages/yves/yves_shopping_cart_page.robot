...
&{shopping_cart_upp-sell_products_section}    b2b=xpath=//main[contains(@class,'cart')]//slick-carousel[@data-qa='component slick-carousel']    b2c=xpath=//div[contains(@data-qa,'component extra-product')]
