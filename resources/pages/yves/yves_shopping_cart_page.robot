...
${shopping_cart_search_product_input_field_locator}    xpath=//input[contains(@class,"product-search-autocomplete-form__input js-product-search-autocomplete-form__input")]
${shopping_cart_searched_product_quantity_input_field_locator}    id=quantity
${shopping_cart_add_button}    xpath=//button[contains(@class,"button--success")]
