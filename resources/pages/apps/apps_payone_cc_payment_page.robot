*** Variables ***
${apps_payone_payment_cc_card_type}       xpath=//select[@id='cardtype']
${apps_payone_payment_cc_name_on_card}    xpath=//input[@id='cardholder']
...
${apps_payone_payment_pay_btn}            xpath=//input[@id='paymentsubmit']
