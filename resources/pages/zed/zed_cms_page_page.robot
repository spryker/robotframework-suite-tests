...
${zed_cms_page_general_deDE_collapsed_section}    xpath=(//*[contains(.,'de_DE')]/ancestor::div[contains(@class,'ibox nested collapsed')]//i[contains(@class,'plus')])\[1\]
${zed_cms_page_general_deDE_expanded_section}    xpath=(//*[contains(.,'de_DE')]/ancestor::div[contains(@class,'ibox nested collapsed')]//i[contains(@class,'minus')])\[1\]
${zed_cms_page_general_deDE_content_collapsed_section}    xpath=(//*[contains(.,'de_DE')]/ancestor::div[contains(@class,'ibox nested collapsed')]//i[contains(@class,'plus')])\[3\]
