...
${zed_global_threshold_minimum_hard_de_collapce_section}    xpath=//input[@id='global-threshold_hardThreshold_threshold']/../../div[contains(@class,'ibox nested collapsed')]//i[contains(@class,'plus')]
...
${zed_global_threshold_maximum_hard_de_collapce_section}    xpath=//input[@id='global-threshold_hardMaximumThreshold_threshold']/../../div[contains(@class,'ibox nested collapsed')]//i[contains(@class,'plus')]
...
${zed_global_threshold_soft_de_collapce_section}    xpath=//input[@id='global-threshold_softThreshold_de_DE_message']/../../../../div[contains(@class,'ibox nested collapsed')]//i[contains(@class,'plus')]
