...
Zed: switch to the tab on 'Edit product' page:
    [Arguments]    ${tabToUse}
    Click    xpath=//form[contains(@name,'form_edit')]/div[@class='tabs-container']/ul[contains(@class,'nav-tabs')]/li[@data-bs-toggle='tab']/a[text()='${tabToUse}']

Zed: switch to the tab on 'Add product' page:
    [Arguments]    ${tabToUse}
    Click    xpath=//form[contains(@name,'form_add')]/div[@class='tabs-container']/ul[contains(@class,'nav-tabs')]/li[@data-bs-toggle='tab']/a[text()='${tabToUse}']
