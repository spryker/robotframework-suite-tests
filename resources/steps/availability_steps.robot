...
Zed: update warehouse:
    ...
    FOR    ${key}    ${value}    IN    &{warehouseData}
        ...
        IF    '${key}'=='store' and '${value}' != '${EMPTY}'
            Click    xpath=//div[@class='tabs-container']/ul[contains(@class,'nav-tabs')]/li[@data-bs-toggle='tab']/a[text()='Store Relation']
            Zed: Check checkbox by Label:    ${value}
            Click    xpath=//div[@class='tabs-container']/ul[contains(@class,'nav-tabs')]/li[@data-bs-toggle='tab']/a[text()='Configuration']
        END
