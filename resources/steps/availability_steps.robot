...
Zed: update warehouse:
    ...
    FOR    ${key}    ${value}    IN    &{warehouseData}
        ...
        IF    '${key}'=='store' and '${value}' != '${EMPTY}'
            Click    xpath=//div[@class='tabs-container']/ul[contains(@class,'nav-tabs')]//a[@data-bs-toggle='tab'][text()='Store Relation']
            Zed: Check checkbox by Label:    ${value}
            Click    xpath=//div[@class='tabs-container']/ul[contains(@class,'nav-tabs')]//a[@data-bs-toggle='tab'][text()='Configuration']
        END
