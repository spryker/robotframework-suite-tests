...
Yves: find and add new item in the quick order form:
    ...
    Wait Until Page Contains Element    xpath=(//div[contains(@data-qa,'component quick-order-rows')]//*[contains(@class,'autocomplete')][@value=''])[1]/ancestor::quick-order-row[1]//ul[@data-qa='component products-list']/li[@data-value='${searchQuery}'][1]
    Click    xpath=(//div[contains(@data-qa,'component quick-order-rows')]//*[contains(@class,'autocomplete')][@value=''])[1]/ancestor::quick-order-row[1]//ul[@data-qa='component products-list']/li[@data-value='${searchQuery}'][1]
    TRY
        Repeat Keyword    3    Wait For Load State
        Repeat Keyword    3    Wait For Load State    domcontentloaded
    EXCEPT
