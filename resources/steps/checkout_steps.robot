...
Yves: fill in new delivery address for a product:
    ...
    FOR    ${key}    ${value}    IN    &{newAddressData}
        ...
        IF    '${key}'=='city' and '${value}' != '${EMPTY}'    Type Text    xpath=//article[contains(@data-qa,'component product-card-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//textarea[contains(@name,'[city]')]    ${value}
