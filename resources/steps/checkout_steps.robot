...
Yves: fill in new delivery address for a product:
    ...
    FOR    ${key}    ${value}    IN    &{newAddressData}
        ...
        IF    '${key}'=='product' and '${value}' != '${EMPTY}'
            ...
            IF    '${env}' not in ['ui_suite']    Select From List By Label    xpath=//article[contains(@data-qa,'component product-card-item')]//*[contains(.,'${item}')]//select | //product-cart-item[contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]//select    Define new address
            IF    '${env}' in ['ui_suite']
        ...
        END
        IF    '${env}' in ['ui_mp_b2c']
            IF    '${key}'=='salutation' and '${value}' != '${EMPTY}'    Select From List By Label    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//select[contains(@name,'[salutation]')]    ${value}
            IF    '${key}'=='firstName' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//input[contains(@name,'[first_name]')]    ${value}
            IF    '${key}'=='lastName' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//input[contains(@name,'[last_name]')]    ${value}
            IF    '${key}'=='street' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//input[contains(@name,'[address1]')]    ${value}
            IF    '${key}'=='houseNumber' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//input[contains(@name,'[address2]')]    ${value}
            IF    '${key}'=='postCode' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//input[contains(@name,'[zip_code]')]    ${value}
            IF    '${key}'=='city' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//*[self::input or self::textarea][contains(@name,'[city]')]    ${value}
            IF    '${key}'=='country' and '${value}' != '${EMPTY}'    Select From List By Label    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//select[contains(@name,'[iso2_code]')]    ${value}
            IF    '${key}'=='company' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//input[contains(@name,'[company]')]    ${value}
            IF    '${key}'=='phone' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//input[contains(@name,'[phone]')]    ${value}
            IF    '${key}'=='additionalAddress' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::*[self::article or self::product-cart-item]/following-sibling::div[contains(@class,'address-item-form')]//input[contains(@name,'[address3]')]    ${value}
        ...
        ELSE
            IF    '${key}'=='salutation' and '${value}' != '${EMPTY}'    Select From List By Label    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//select[contains(@name,'[salutation]')]    ${value}
            IF    '${key}'=='firstName' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//input[contains(@name,'[first_name]')]    ${value}
            IF    '${key}'=='lastName' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//input[contains(@name,'[last_name]')]    ${value}
            IF    '${key}'=='street' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//input[contains(@name,'[address1]')]    ${value}
            IF    '${key}'=='houseNumber' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//input[contains(@name,'[address2]')]    ${value}
            IF    '${key}'=='postCode' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//input[contains(@name,'[zip_code]')]    ${value}
            IF    '${key}'=='city' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//*[self::input or self::textarea][contains(@name,'[city]')]    ${value}
            IF    '${key}'=='country' and '${value}' != '${EMPTY}'    Select From List By Label    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//select[contains(@name,'[iso2_code]')]    ${value}
            IF    '${key}'=='company' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//input[contains(@name,'[company]')]    ${value}
            IF    '${key}'=='phone' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//input[contains(@name,'[phone]')]    ${value}
            IF    '${key}'=='additionalAddress' and '${value}' != '${EMPTY}'    Type Text    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]/ancestor::div[contains(@class,'address-item-form')][1]//input[contains(@name,'[address3]')]    ${value}
        END
    END
    TRY
        Repeat Keyword    3    Wait For Load State
...
Yves: select xxx shipment type for item xxx:
    ...
    Click    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(.,'${item}')]//shipment-type-toggler//span[contains(@data-qa,'shipmentType')]//span[contains(text(), '${shipment_type}')]
    TRY
        Repeat Keyword    3    Wait For Load State
    EXCEPT
        Log    Page is not loaded
...
Yves: checkout summary page contains product with unit price:
    ...
    IF    '${env}' in ['ui_b2b','ui_mp_b2b']
        TRY
            Page Should Contain Element    xpath=//div[contains(@class,'product-card-item__col--description')]//div[contains(.,'SKU: ${sku}')]/ancestor::*[self::article or self::product-cart-item]//*[contains(@class,'product-card-item__col--description')]/div[1]//*[contains(@class,'money-price__amount')][contains(.,'${productPrice}')] | //product-cart-item[contains(@data-qa,'component product-cart-item')][.//*[@data-qa='cart-item-sku'][contains(.,'${sku}')]]//*[contains(@class,'money-price__amount')][contains(.,'${productPrice}')]    timeout=100ms
        EXCEPT
            Page Should Contain Element    xpath=//div[contains(@class,'product-cart-item__col--description')]//div[contains(.,'SKU: ${sku}')]/ancestor::*[self::article or self::product-cart-item]//*[contains(@class,'product-cart-item__col--description')]/div[1]//*[contains(@class,'money-price__amount')][contains(.,'${productPrice}')] | //product-cart-item[contains(@data-qa,'component product-cart-item')][.//*[@data-qa='cart-item-sku'][contains(.,'${sku}')]]//*[contains(@class,'money-price__amount')][contains(.,'${productPrice}')]    timeout=100ms
        END
    ELSE IF    '${env}' in ['ui_suite']
    ...
    ELSE
        Page Should Contain Element    xpath=//*[self::article or self::product-cart-item][contains(@data-qa,'component product-card-item') or contains(@data-qa,'component product-cart-item')]//*[contains(text(),'${productName}')]/following-sibling::span/span[contains(@class,'money-price__amount') and contains(.,'${productPrice}')]    timeout=1s
    END
