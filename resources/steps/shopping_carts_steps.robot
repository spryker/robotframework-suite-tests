...
Yves: go to the shopping cart through the header with name:
    ...
    ELSE IF    '${env}' in ['ui_mp_b2b']
        Click    xpath=//header//div[contains(@class,'header-cart-pill__dropdown')]//*[@data-qa='component mini-cart-detail']//a[.//*[contains(@class,'mini-cart-detail__name')][normalize-space()='${shoppingCartName}']]
    ELSE
