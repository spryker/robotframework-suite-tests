...
# Placeholder information input
    ...
    ${de_section_expanded}=    Run Keyword And Return Status    Wait Until Element Is Visible    ${zed_cms_page_placeholder_title_deDE_field}    message=DE section of CMS page is not open
    IF    '${de_section_expanded}'=='False'
        Scroll Element Into View    ${zed_cms_page_content_deDE_title_collapsed_section}
        Click    ${zed_cms_page_content_deDE_title_collapsed_section}
    END
    ...
    ${de_section_expanded}=    Run Keyword And Return Status    Wait Until Element Is Visible    ${zed_cms_page_placeholder_content_deDE_field}    message=DE section of CMS page is not open
    IF    '${de_section_expanded}'=='False'
        Scroll Element Into View    ${zed_cms_page_content_deDE_content_collapsed_section}
        Click    ${zed_cms_page_content_deDE_content_collapsed_section}
    END
