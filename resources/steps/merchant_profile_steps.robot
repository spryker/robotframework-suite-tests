...
Yves: assert name of merchant on profile page:
    ...
    Try reloading page until element does/not contain text:    ${merchant_profile_name_header_locator}     ${merchantName}     true    5    15s
...
Yves: assert merchant profile fields:
    ...
    Wait Until Element Is Visible    ${merchant_profile_main_content_locator}
    Try reloading page until element does/not contain text:    ${merchant_profile_email_locator}    ${merchantProfileEmail}    true    5    15s      
