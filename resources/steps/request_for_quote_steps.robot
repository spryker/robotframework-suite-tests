...
Yves: click '${buttonName}' button on the 'Quote Request Details' page
    ...
    ...    ELSE IF    '${buttonName}' == 'Convert to Cart'    Click    ${quote_request_convert_to_cart_button}
    ...    ELSE IF    '${buttonName}' == 'Send to Customer'    Click    ${quote_request_send_to_customer_button}
    ...    ELSE IF    '${buttonName}' == 'Edit'    Click    ${quote_request_edit_button}
    ...    ELSE IF    '${buttonName}' == 'Edit Items'    Click    ${quote_request_edit_items_button}
