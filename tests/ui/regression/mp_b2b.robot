...
#     ...    || M58035       | 102124       | AT    | CHF      | 110       | 120         | ORIGINAL   | 2023-07-02 | 11         | 2030-07-14 | 06       ||
#     Zed: update concrete product scheduled prices:
#     ...    || abstract_sku | concrete_sku | store | currency | net price | gross price | price type | start from | hours from | finish at   | hours to ||
#     ...    || M58035       | 102124       | DE    | CHF      | 200       | 250         | DEFAULT    | 2023-05-03 | 12         | 2030-07-15  | 07       ||
#     # DE, EUR, net price, valide dates, default/originnal prices
#     Zed: update concrete product scheduled prices:
#     ...    || abstract_sku | concrete_sku | store | currency | net price | gross price | price type | start from | hours from | finish at   | hours to ||
#     ...    || M58035       | 102126       | DE    | EUR      | 300       | 350         | DEFAULT    | 2023-06-04 | 13         | 2030-07-16  | 08       ||
#     Zed: update concrete product scheduled prices:
#     ...    || abstract_sku | concrete_sku | store | currency | net price | gross price | price type | start from | hours from | finish at   | hours to ||
#     ...    || M58035       | 102126       | DE    | EUR      | 290       | 340         | ORIGINAL   | 2022-07-05 | 14         | 2030-07-18  | 09       ||
...
#     # # Trigger p&s
    ...
    Yves: change price type on:    Gross prices
...
#     ...    AND    Yves: change price type on:    Gross prices
