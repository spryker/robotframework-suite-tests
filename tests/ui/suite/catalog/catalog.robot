...
Configurable_Product_PDP_Wishlist_Availability
    [Documentation]    Configure product from PDP and Wishlist + availability case. Bug:CC-33647
    ...
    ...    || 389.50     | 210        ||
    Yves: product configuration price should be:    932.99
    Yves: product configuration should be not available:    No item available for your configuration
    Yves: change the product options in configurator to:
    ...    || option one | option two ||
    ...    || 607        | 275        ||
    Yves: save product configuration
    Yves: product configuration status should be equal:      Configuration complete!
    Yves: product price on the PDP should be:    €882.00
