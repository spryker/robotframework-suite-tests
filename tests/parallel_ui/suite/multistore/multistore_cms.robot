...
Test Tags    robot:recursive-stop-on-failure    group_tree    cms    content-item    spryker-core-back-office
...
Multistore_CMS
    ...
    Yves: go to newly created page by URL on AT store if other store not specified:    en/multistore-page${random}    delay=10s
    Save current URL
