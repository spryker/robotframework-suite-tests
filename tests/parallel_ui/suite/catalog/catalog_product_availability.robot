...
Test Tags    robot:recursive-stop-on-failure    group_one    prices    spryker-core-back-office    spryker-core    product    cart    checkout    inventory-management    order-management
