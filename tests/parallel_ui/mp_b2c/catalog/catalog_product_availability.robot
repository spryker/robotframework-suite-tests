...
Test Tags    robot:recursive-stop-on-failure    group_one    prices    marketplace-merchant-portal-product-management    spryker-core    product    cart    checkout    inventory-management    order-management
