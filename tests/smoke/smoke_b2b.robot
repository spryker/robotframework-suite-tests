...
Business_on_Behalf
    ...
    Yves: select businees unit name and click on remember me:    Spryker Systems GmbH / Spryker Systems Zurich    true
    Yves: logout on Yves as a customer
    Yves: login on Yves with provided credentials:    ${yves_company_user_bob_email}
    Yves: go to URL:    company/user/select
    Yves: 'Select Business Unit' page is displayed
    Yves: verify business unit is pre-defined in drop-down:    Spryker Systems GmbH / Spryker Systems Zurich
    Zed: login on Zed with provided credentials:    ${zed_admin_email}
    Zed: go to second navigation item level:    Customers    Company Users
    Zed: disable company user xxx within xxx company business unit:    Donald    Spryker Systems Zurich
    Zed: message should be shown:    Company user successfully disabled
    Yves: login on Yves with provided credentials:    ${yves_company_user_bob_email}
    Yves: go to URL:    company/user/select
    Yves: 'Select Business Unit' page is displayed
    Yves: verify business unit is not shown in drop-down:    Spryker Systems GmbH / Spryker Systems Zurich
