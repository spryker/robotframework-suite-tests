...
Company Account in zed
    ...
    Zed: Create new Company User with provided email/company/business unit and role(s):    abc${random}@mail.com    meta    Headquarters    ADMINISTRATOR
    ...
    [Teardown]    Run Keywords    Zed: delete company user xxx withing xxx company business unit:    ${random}    Headquarters
