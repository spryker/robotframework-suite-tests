...
Share_Shopping_Lists
    ...
    Yves: login with credentials:    ${yves_company_user_shared_permission_owner_email}
    ...
    Create New Context
    Yves: login with credentials:    ${yves_company_user_shared_permission_receiver_email}
...
Share_Shopping_Carts
    ...
    Yves: go to PDP with sku:    M10569
...
Quick_Order
    ...
    [Setup]    Run keywords    Yves: login with credentials:    ${yves_company_user_buyer_email}
    ...
    Yves: login with credentials:    ${yves_company_user_buyer_email}
    Yves: go to 'Quick Order' page through the header
    Yves: add the following articles into the form through quick order text area:    401627,1\n520561,3\n101509,21\n419871,1\n419869,11\n425073,1\n425084,2
...
Volume_Prices
    ...
    Yves: go to PDP with sku:    M21189
...
Discontinued_Alternative_Products
    ...
    Yves: go to PDP with sku:  M21100
...
Measurement_Units
    ...
    [Setup]    Run keywords    Yves: login with credentials:    ${yves_company_user_manager_and_buyer_email}
    ...    AND    Yves: create new 'Shopping Cart' with name:    measurementUnitsCart+${random}
    Yves: go to PDP with sku:    M23723
    ...
    Yves: change quantity using '+' or '-' button № times:    -    1
    Yves: add product to the shopping cart
    Yves: go to PDP with sku:    M1006871
    Yves: add product to the shopping cart
...
Packaging_Units
    ...
    Yves: go to PDP with sku:    M21766
...
Product_Restrictions
    ...
    Yves: logout on Yves as a customer
    Yves: login with credentials:    ${yves_company_user_restriction_customer_email_1}
    Yves: perform search by:    Soennecken
    Yves: 'Catalog' page should show products:    0
    Yves: logout on Yves as a customer
    Yves: login with credentials:    ${yves_company_user_restriction_customer_email_2}
    Yves: go to URL:    en/office-furniture/storage/lockers
    Yves: 'Catalog' page should show products:    0
...
Customer_Specific_Prices
    ...
    Yves: logout on Yves as a customer
    Yves: login with credentials:    ${yves_company_user_special_prices_customer_email}
...
Agent_Assist
    ...
    Yves: login with credentials:    agent+${random}@spryker.com    change123${random}
...
Business_on_Behalf
    ...
    Yves: login with credentials:    ${yves_company_user_bob_email}
...
Business_Unit_Address_on_Checkout
    ...
    Yves: go to PDP with sku:    M64933
    Yves: add product to the shopping cart
...
Approval_Process
    ...
    [Setup]    Run keywords    Yves: login with credentials:    ${yves_company_user_buyer_with_limit_email}
    ...    AND    Yves: create new 'Shopping Cart' with name:    approvalCart+${random}
    Yves: go to PDP with sku:    M49320
    Yves: add product to the shopping cart
    ...
    Yves: go to PDP with sku:    M58314
    Yves: add product to the shopping cart
    ...
    Yves: 'Summary' page contains/doesn't contain:    true    ${cancelRequestButton}    ${alertWarning}    ${quoteStatus}
    Yves: logout on Yves as a customer
    Yves: login with credentials:    ${yves_company_user_approver_email}
    ...
    Yves: shopping cart with name xxx has the following status:    anotherApprovalCart+${random}    Waiting
    Yves: logout on Yves as a customer
    Yves: login with credentials:    ${yves_company_user_buyer_with_limit_email}
    Yves: go to user menu item in the left bar:    Shopping carts
    Yves: shopping cart with name xxx has the following status:    approvalCart+${random}    Approved
    Yves: go to the shopping cart through the header with name:    approvalCart+${random}
    Yves: shopping cart contains/doesn't contain elements:    true    ${lockedCart}
...
Request_for_Quote
    ...
    Yves: go to PDP with sku:    ${one_variant_product_abstract_sku}
    Yves: add product to the shopping cart
    Yves: go to PDP with sku:    M1018212
    Yves: add product to the shopping cart
    ...
    Yves: logout on Yves as a customer
    Yves: go to URL:    agent/login
    Yves: login with credentials:    agent_quote+${random}@spryker.com    change123${random}
...
#     Yves: go to PDP with sku:    M90806
#     Yves: add product to the shopping cart
...
Return_Management
    ...
    Yves: go to PDP with sku:    M90802
    Yves: add product to the shopping cart
    Yves: go to PDP with sku:    M21711
    Yves: add product to the shopping cart
    Yves: go to PDP with sku:    M90737
    Yves: add product to the shopping cart
    ...
    Zed: login with credentials:    admin@spryker.com
    ...
    Yves: logout on Yves as a customer
    Yves: go to URL:    agent/login
    Yves: login with credentials:    return+agent+${random}@spryker.com    change123${random}
    Yves: header contains/doesn't contain:    true    ${customerSearchWidget}
...
User_Account
    ...
    Yves: login with credentials:    ${yves_user_email}
    Yves: go to user menu item in header:    Overview
    Yves: 'Overview' page is displayed
    Yves: go to user menu item in header:    Order History
    Yves: 'Order History' page is displayed
...
Product_PDP
    ...
    Yves: go to PDP with sku:    ${multi_variant_product_abstract_sku}
...
Discounts
    ...
    Yves: go to PDP with sku:    M21777
    Yves: add product to the shopping cart
...
Split_Delivery
    ...
    Yves: go to PDP with sku:    ${one_variant_product_abstract_sku}
    Yves: add product to the shopping cart
    Yves: go to PDP with sku:    ${multi_color_product_abstract_sku}
    Yves: add product to the shopping cart
    Yves: go to PDP with sku:    ${product_with_relations_related_products_sku}
    Yves: add product to the shopping cart
...
Refunds
    ...
    ...    AND    Yves: login with credentials:    ${yves_company_user_buyer_email}
