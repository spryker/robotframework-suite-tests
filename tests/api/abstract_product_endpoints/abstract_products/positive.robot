...
Abstract_product_with_3_concrete3
    ...
    And Each array element of array in response should contain value:    [data][attributes][attributeMap][product_concrete_ids]    ${abstract_available_product_with_3_concretes}
