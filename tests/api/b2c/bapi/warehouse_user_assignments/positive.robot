...
Assign_user_to_warehouse
    ...
    ...    AND    Make user a warehouse user/ not a warehouse user:   ${warehouse_user_assigment.user_uuid}    1
    When I send a POST request:    /warehouse-user-assignments    {"data": {"type": "warehouse-user-assignments", "attributes":{"userUuid": "${warehouse_user_assigment.user_uuid}","warehouse" :{"uuid": "${warehouse.warehouse_uuid}"},"isActive":"false"}}}
    ...
    And Response body parameter should be:    [data][attributes][warehouse][name]    ${warehouse.warehouse_name}
    ...
    ...  AND    Make user a warehouse user/ not a warehouse user:   ${warehouse_user_assigment.user_uuid}    0

Assign_user_to_warehouse_with_include
    [Setup]    Run Keywords    I get access token by user credentials:    ${zed_user.email}
    ...    AND    I set Headers:    Content-Type=${default_header_content_type}    Authorization=Bearer ${token}
    ...    AND    Make user a warehouse user/ not a warehouse user:   ${warehouse_user_assigment.user_uuid}    1
    When I send a POST request:    /warehouse-user-assignments?include=users    {"data": {"type": "warehouse-user-assignments", "attributes":{"userUuid": "${warehouse_user_assigment.user_uuid}","warehouse" :{"uuid": "${warehouse.warehouse_uuid}"},"isActive":"false"}}}
    Then Response status code should be:    201
    Then Save value to a variable:    [data][id]   warehouse_assigment_id
    ...
    And Response body parameter should be:    [included][0][attributes][username]    ${warehouse_user_assigment.user_name}
    And Response body parameter should be:    [included][0][attributes][firstName]    ${warehouse_user_assigment.user_first_name}
    And Response body parameter should be:    [included][0][attributes][lastName]    ${warehouse_user_assigment.user_last_name}
    [Teardown]     Run Keywords    I send a DELETE request:    /warehouse-user-assignments/${warehouse_assigment_id}
    ...  AND    Response status code should be:    204
    ...  AND    Make user a warehouse user/ not a warehouse user:   ${warehouse_user_assigment.user_uuid}    0
...
Get_warehouse_user_assigments_list
    ...
    When I send a POST request:    /warehouse-user-assignments?include=users    {"data": {"type": "warehouse-user-assignments", "attributes":{"userUuid": "${warehouse_user_assigment.user_uuid}","warehouse" :{"uuid": "${warehouse.video_king_warehouse_uuid}"},"isActive":"true"}}}
    Then Response status code should be:    201
    ...
    And Response body parameter should be:    [data][0][attributes][userUuid]    ${warehouse_user_assigment.user_uuid}
    And Response body parameter should be:    [data][1][attributes][userUuid]    ${warehouse_user_assigment.user_uuid}
    ...
    And Response body parameter should be in:    [data][0][attributes][warehouse][name]    ${warehouse.warehouse_name}    ${warehouse.video_king_warehouse_name}
    And Response body parameter should be in:    [data][1][attributes][warehouse][name]    ${warehouse.warehouse_name}    ${warehouse.video_king_warehouse_name}
...
Get_warehouse_user_assigments_with_filter_by_warehouse_assigment_uuid
    ...
    ...    AND    Make user a warehouse user/ not a warehouse user:   ${warehouse_user_assigment.user_uuid}    1
    ...    AND    Make user a warehouse user/ not a warehouse user:   ${warehouse_user_assigment.user_uuid_2}    1
    When I send a POST request:    /warehouse-user-assignments?include=users    {"data": {"type": "warehouse-user-assignments", "attributes":{"userUuid": "${warehouse_user_assigment.user_uuid}","warehouse" :{"uuid": "${warehouse.warehouse_uuid}"},"isActive":"false"}}}
    Then Response status code should be:    201
    Then Save value to a variable:    [data][id]   warehouse_assigment_id_1
    When I send a POST request:    /warehouse-user-assignments?include=users    {"data": {"type": "warehouse-user-assignments", "attributes":{"userUuid": "${warehouse_user_assigment.user_uuid_2}","warehouse" :{"uuid": "${warehouse.warehouse_uuid}"},"isActive":"true"}}}
    Then Response status code should be:    201
    Then Save value to a variable:    [data][id]   warehouse_assigment_id_2
    ...
    And Response body parameter should be:    [data][0][attributes][warehouse][name]    ${warehouse.warehouse_name}
    And Response body parameter should be:    [data][0][attributes][warehouse][uuid]    ${warehouse.warehouse_uuid}
    And Response body parameter should be:    [data][0][attributes][warehouse][isActive]    True
    [Teardown]     Run Keywords    I send a DELETE request:    /warehouse-user-assignments/${warehouse_assigment_id_1}
    ...  AND    Response status code should be:    204
    ...  AND    I send a DELETE request:    /warehouse-user-assignments/${warehouse_assigment_id_2}
    ...  AND    Response status code should be:    204
    ...  AND    Make user a warehouse user/ not a warehouse user:   ${warehouse_user_assigment.user_uuid}    0
    ...  AND    Make user a warehouse user/ not a warehouse user:   ${warehouse_user_assigment.user_uuid_2}    0
...
Get_warehouse_user_assigments_with_filter_by_warehouse_uuid
    ...
    Then Response status code should be:    201
    Then Save value to a variable:    [data][id]   warehouse_assigment_id_1
    When I send a POST request:    /warehouse-user-assignments?include=users    {"data": {"type": "warehouse-user-assignments", "attributes":{"userUuid": "${warehouse_user_assigment.user_uuid_2}","warehouse" :{"uuid": "${warehouse.video_king_warehouse_uuid}"},"isActive":"true"}}}
    Then Response status code should be:    201
    Then Save value to a variable:    [data][id]   warehouse_assigment_id_2
    Then I send a GET request:    /warehouse-user-assignments/?filter[warehouse-user-assignments.warehouseUuid]=${warehouse.video_king_warehouse_uuid}
    Then Response status code should be:    200
    And Response body parameter should be:    [data][0][id]    ${warehouse_assigment_id_2}
    And Response body parameter should be:    [data][0][attributes][userUuid]    ${warehouse_user_assigment.user_uuid_2}
    And Response body parameter should be:    [data][0][attributes][isActive]    True
    And Response body parameter should be:    [data][0][attributes][warehouse][name]    ${warehouse.video_king_warehouse_name}
    And Response body parameter should be:    [data][0][attributes][warehouse][uuid]    ${warehouse.video_king_warehouse_uuid}
    And Response body parameter should be:    [data][0][attributes][warehouse][isActive]    True
    [Teardown]     Run Keywords    I send a DELETE request:    /warehouse-user-assignments/${warehouse_assigment_id_1}
    ...  AND    Response status code should be:    204
    ...  AND    I send a DELETE request:    /warehouse-user-assignments/${warehouse_assigment_id_2}
...
Get_warehouse_user_assigments_with_filter_by_user_uuid
    ...
    Then Response status code should be:    201
    Then Save value to a variable:    [data][id]   warehouse_assigment_id_2
    Then I send a GET request:    /warehouse-user-assignments/?filter[warehouse-user-assignments.userUuid]=${warehouse_user_assigment.user_uuid}
    Then Response status code should be:    200
    And Response body parameter should be:    [data][0][id]    ${warehouse_assigment_id_1}
    And Response body parameter should be:    [data][0][attributes][userUuid]    ${warehouse_user_assigment.user_uuid}
    And Response body parameter should be:    [data][0][attributes][isActive]    False
...
Create_warehouse_user_assignment_with_multiple_active_assignments
    ...
    ...    AND    I set Headers:    Content-Type=${default_header_content_type}    Authorization=Bearer ${token}
    ...    AND    Make user a warehouse user/ not a warehouse user:   ${warehouse_user_assigment.user_uuid}    1
    When I send a POST request:    /warehouse-user-assignments    {"data": {"type": "warehouse-user-assignments", "attributes":{"userUuid": "${warehouse_user_assigment.user_uuid}","warehouse" :{"uuid": "${warehouse.warehouse_uuid}"},"isActive":"true"}}}
    Then Save value to a variable:    [data][id]   warehouse_assigment_id
    Then I send a GET request:    /warehouse-user-assignments/${warehouse_assigment_id}
    And Response body parameter should be:    [data][attributes][isActive]    True
    When I send a POST request:    /warehouse-user-assignments    {"data": {"type": "warehouse-user-assignments", "attributes":{"userUuid": "${warehouse_user_assigment.user_uuid}","warehouse" :{"uuid": "${warehouse.video_king_warehouse_uuid}"},"isActive":"true"}}}
    Then Save value to a variable:    [data][id]   warehouse_assigment_id_2
