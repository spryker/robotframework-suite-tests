...
Get_abstract_prices_by_concrete_SKU
    When I send a GET request:    /abstract-products/${concrete_product_with_abstract_product_alternative.sku}/abstract-product-prices?currency=EUR&priceMode=GROSS_MODE
