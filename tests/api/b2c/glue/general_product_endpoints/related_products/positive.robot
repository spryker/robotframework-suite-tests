...
Product_has_related_products
    When I send a GET request:    /abstract-products/${abstract_available_product_with_stock_one_concrete_with_superattribute}/related-products
    ...
    And Response body parameter should be:    [data][4][id]    ${product_related_product_with_related_relation_sku}
    And Response body parameter should not be EMPTY:    [data][4][attributes]
    And Response body parameter should be:    [data][4][attributes][sku]    ${product_related_product_with_related_relation_sku}
    ...
    And Response body parameter should be:    [data][4][attributes][name]    ${product_related_product_with_related_relation_name}
