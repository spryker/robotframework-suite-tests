...
Get_search_suggestions_with_discontinued_product_sku
    When I send a GET request:    /catalog-search-suggestions?q=${concrete_product_with_concrete_product_alternative_sku}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    And Response body parameter should be:    [data][0][attributes][completion]    ${concrete_product_with_concrete_product_alternative_sku}
    And Response should contain the array of a certain size:    [data][0][attributes][categories]    0
    And Response should contain the array of a certain size:    [data][0][attributes][cmsPages]    0
    And Response body parameter should be greater than:    [data][0][attributes][abstractProducts][0][price]    0
    And Response body parameter should be:    [data][0][attributes][abstractProducts][0][abstractName]    ${concrete_product_with_concrete_product_alternative_sku_name}
...
Get_search_suggestions_with_all_attributes_data
    When I send a GET request:    /catalog-search-suggestions?q=${concrete_product_with_concrete_product_alternative_sku_name}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    And Response body parameter should be:    [data][0][attributes][completion]    ${concrete_product_with_concrete_product_alternative_sku_name_in_lower_case}
...
Get_search_suggestions_with_few_symbols
    When I send a GET request:    /catalog-search-suggestions?q=len
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    ...
    And Each array element of array in response should contain value:    [data][0][attributes][completion]    len
    And Each array element of array in response should contain value:    [data][0][attributes][abstractProducts]    len
    And Response body has correct self link
...
Get_search_suggestions_with_brand_and_currency
    When I send a GET request:    /catalog-search-suggestions?q=${brand_name}&currency=${currency_code_chf}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    ...
    And Response should contain the array of a certain size:    [data][0][attributes][completion]    10
    And Response should contain the array of a certain size:    [data][0][attributes][abstractProducts]    10
    And Response body parameter should be:    [data][0][attributes][abstractProducts][8][price]    ${alternative_abstract_product_price_chf}
    And Response body has correct self link
...
Get_search_suggestions_with_abstract_product_sku_and_included_abstract_products
    ...
    And Response body parameter should be:    [included][0][attributes][attributes][color]    ${color_4}
