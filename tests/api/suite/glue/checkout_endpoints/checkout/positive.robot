...
Create_order_include_orders
    ...
    ...    ${yves_second_user.salutation}
    And Response body parameter should be:
    ...    [included][0][attributes][billingAddress][firstName]
    ...    ${yves_second_user.first_name}
    ...
    ...    ${product_availability.concrete_available_with_stock_and_never_out_of_stock_name}
    And Response body parameter should be:
    ...    [included][0][attributes][items][0][sku]
    ...    ${product_availability.concrete_available_with_stock_and_never_out_of_stock}
...
Create_order_with_split_shipments
    ...
    ...    ${product_availability.concrete_available_with_stock_and_never_out_of_stock_sku_name}
    And Response body parameter should be:
    ...    [included][0][attributes][items][1][sku]
    ...    ${product_availability.concrete_available_with_stock_and_never_out_of_stock_sku}
...
Create_order_with_free_shipping_discount
    ...
    And Response body parameter should be:
    ...    [included][0][attributes][shipments][0][shipmentMethodName]
    ...    ${shipment.method_1.name}
    And Response body parameter should be:
    ...    [included][0][attributes][shipments][0][carrierName]
    ...    ${shipment.method_1.carrier_name}
    And Response body parameter should be:    [included][0][attributes][shipments][0][deliveryTime]    None
    And Response body parameter should be:
    ...    [included][0][attributes][shipments][0][defaultGrossPrice]
    ...    ${shipment.method_1.price_eur}
    ...
    ...    sumAmount: ${shipment.method_1.price_eur}
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...    displayName: ${discount_3.name}
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...    description: ${discount_3.description}
...
Create_order_with_2_product_discounts
    ...
    And Perform arithmetical calculation with two arguments:
    ...    discount_total_sum
    ...    ${discount_1.total_sum_for_discounts_for_products_1_and_2}
    ...    +
    ...    ${discount_2.total_sum_for_discounts_for_products_1_2}
    And Perform arithmetical calculation with two arguments:
    ...    discount_total_sum
    ...    ${discount_total_sum}
    ...    +
    ...    ${discount_3.total_sum_for_discounts_for_products_1_2}
    And Response body parameter with rounding should be:
    ...
    ...    ${discount_concrete_product.product_1.discount_20_percentage_off_cameras_amount}
    ...    ${discount_concrete_product.product_1.discount_10_percentage_off_above_100_amount}
    And Response body parameter should be in:
    ...
    ...    ${discount_1.description}
    ...    ${discount_2.description}
    And Response body parameter should be:
    ...
    And Response body parameter should be:
    ...    [included][0][attributes][items][1][name]
    ...    ${discount_concrete_product.product_2.name}
    And Response body parameter should be:
    ...    [included][0][attributes][items][1][sku]
    ...    ${discount_concrete_product.product_2.sku}
    And Response body parameter should be in:
    ...    [included][0][attributes][items][1][calculatedDiscounts][0][unitAmount]
    ...    ${discount_concrete_product.product_2.discount_20_percentage_off_cameras_amount}
    ...    ${discount_concrete_product.product_2.discount_10_percentage_off_above_100_amount}
    And Response body parameter should be in:
    ...
    ...    ${discount_concrete_product.product_2.discount_10_percentage_off_above_100_amount}
    And Response body parameter should be in:
    ...    [included][0][attributes][items][1][calculatedDiscounts][1][displayName]
    ...    ${discount_1.name}
    ...    ${discount_2.name}
    And Response body parameter should be in:
    ...    [included][0][attributes][items][1][calculatedDiscounts][1][description]
    ...    ${discount_1.description}
    ...    ${discount_2.description}
    And Response body parameter should be:
    ...    [included][0][attributes][items][1][calculatedDiscounts][1][voucherCode]
    ...    None
    And Response body parameter should be:
    ...    [included][0][attributes][items][1][calculatedDiscounts][1][quantity]
    ...    1
    #calculatedDiscounts - "20% off storage" discount
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    unitAmount: None
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...    sumAmount: ${discount_1.total_sum_for_discounts_for_products_1_and_2}
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...    displayName: ${discount_1.name}
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...    description: ${discount_1.description}
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    voucherCode: None
    ...
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...    sumAmount: ${discount_2.total_sum_for_discounts_for_products_1_2}
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...    displayName: ${discount_2.name}
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...    sumAmount: ${discount_3.total_sum_for_discounts_for_products_1_2}
    And Response body parameter should contain:
    ...    [included][0][attributes][calculatedDiscounts]
    ...    displayName: ${discount_3.name}
    And Response body parameter should contain:
...
Create_order_with_configurable_bundle_item
    ...
    And Response body parameter should be:
    ...    [included][0][attributes][items][0][name]
    ...    ${configurable_bundle_first_slot_item_name}
    And Response body parameter should be:
    ...    [included][0][attributes][items][0][sku]
    ...    ${configurable_bundle_first_slot_item_sku}
    And Response body parameter should be greater than:    [included][0][attributes][items][0][sumPrice]    0
    And Response body parameter should be:    [included][0][attributes][items][0][quantity]    1
    And Response body parameter should be greater than:    [included][0][attributes][items][0][unitGrossPrice]    0
    And Response body parameter should be greater than:    [included][0][attributes][items][0][sumGrossPrice]    0
...
Create_checkout_with_gift_card
    ...
    And Response body parameter should be:
    ...    [included][0][attributes][payments][0][paymentProvider]
    ...    ${gift_card.paymentProvider}
    And Response body parameter should be:
    ...    [included][0][attributes][payments][0][paymentMethod]
    ...    ${gift_card.paymentMethod}
    And Response body parameter should be greater than:    [included][0][attributes][payments][1][amount]    0
    And Response body parameter should be:
    ...    [included][0][attributes][payments][1][paymentProvider]
    ...    ${payment.provider_name_1}
    And Response body parameter should be:
    ...    [included][0][attributes][payments][1][paymentMethod]
    ...    ${payment.method_name}
    #shipments
    And Response body parameter should be:
    ...    [included][0][attributes][shipments][0][shipmentMethodName]
...
Create_checkout_with_gift_card_when_gift_amount_partially_used
    ...
    And Response body parameter should be:
    ...    [included][0][attributes][items][0][name]
    ...    ${concrete_product_with_alternative.product_sku1_name}
    And Response body parameter should be:
    ...    [included][0][attributes][items][0][sku]
    ...    ${concrete_product_with_alternative.product_sku1}
    And Response body parameter should be greater than:    [included][0][attributes][items][0][sumPrice]    0
    And Response body parameter should be:    [included][0][attributes][items][0][quantity]    1
    And Response body parameter should be greater than:    [included][0][attributes][items][0][unitGrossPrice]    0
    And Response body parameter should be greater than:    [included][0][attributes][items][0][sumGrossPrice]    0
