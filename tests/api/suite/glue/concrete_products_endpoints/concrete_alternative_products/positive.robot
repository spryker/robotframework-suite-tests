...
Get_concrete_alternative_product_for_a_product_that_has_none
    ...
    ...    /concrete-products/${bundle_product.concrete.product_1_sku}/concrete-alternative-products
...
Get_concrete_alternative_product
    When I send a GET request:
    ...    /concrete-products/${product_with_alternative.concrete_sku}/concrete-alternative-products
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response reason should be:    OK
...
Get_concrete_alternative_product_with_include
    When I send a GET request:
    ...    /concrete-products/${product_with_alternative.concrete_sku}/concrete-alternative-products?include=concrete-product-image-sets,concrete-product-availabilities,concrete-product-prices
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response reason should be:    OK
    And Response should contain the array of a certain size:    [data]    2
