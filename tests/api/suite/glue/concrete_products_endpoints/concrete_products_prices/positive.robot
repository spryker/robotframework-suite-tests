...
Get_concrete_product_with_only_default_price
    ...
    ...    /concrete-products/${concrete_product.product_with_original_prices.concrete_sku}/concrete-product-prices
    ...
    ...    [data][0][id]
    ...    ${concrete_product.product_with_original_prices.concrete_sku}
...
Get_concrete_product_with_volume_product_prices
    When I send a GET request:
    ...    /concrete-products/${concrete_product.product_with_volume_prices.concrete_sku}/concrete-product-prices
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][0][type]    concrete-product-prices
    And Response body parameter should be:
    ...    [data][0][id]
    ...    ${concrete_product.product_with_volume_prices.concrete_sku}
...
Get_concrete_product_with_CHF_price_and_gross_mode
    When I send a GET request:
    ...    /concrete-products/${concrete_product.product_with_original_prices.concrete_sku}/concrete-product-prices?currency=${currency.chf.code}&priceMode=${mode.gross}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][0][type]    concrete-product-prices
