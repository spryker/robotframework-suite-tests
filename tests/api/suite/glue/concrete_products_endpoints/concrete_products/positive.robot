...
Request_product_concrete_with_included_image_sets
    ...
    ...    /concrete-products/${concrete_product.one_image_set.sku}?include=concrete-product-image-sets
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][type]    concrete-products
...
Request_product_concrete_with_included_availabilities_and_product_prices
    ...
    When I send a GET request:
    ...    /concrete-products/${concrete_product.original_prices.sku}?include=concrete-product-availabilities,concrete-product-prices
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][type]    concrete-products
...
Request_product_concrete_with_included_sales_unit_and_product_measurement_units
    When I send a GET request:
    ...    /concrete-products/${concrete_product.product_with_sales_and_measurement_units.sku}?include=sales-units,product-measurement-units
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][type]    concrete-products
    ...
    ...    [data][id]
    ...    ${concrete_product.product_with_sales_and_measurement_units.sku}
    And Response body parameter should be:
    ...    [data][attributes][sku]
    ...    ${concrete_product.product_with_sales_and_measurement_units.sku}
    And Response body parameter should be:
    ...    [data][attributes][name]
    ...    ${concrete_product.product_with_sales_and_measurement_units.name}
...
Request_product_concrete_with_included_product_labels_and_product_options
    When I send a GET request:
    ...    /concrete-products/${concrete_product.original_prices.sku}?include=product-labels,product-options
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][type]    concrete-products
...
Request_product_concrete_with_included_product_offers
    When I send a GET request:
    ...    /concrete-products/${concrete_product.product_with_concrete_offers.sku}?include=product-offers
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][type]    concrete-products
    ...
    And Response body parameter should be:
    ...    [data][attributes][sku]
    ...    ${concrete_product.product_with_concrete_offers.sku}
    And Response body parameter should be:
    ...    [data][attributes][name]
    ...    ${concrete_product.product_with_concrete_offers.name}
    And Response should contain the array of a certain size:    [data][attributes][attributeNames]    7
    And Response should contain the array of a certain size:    [data][attributes][attributes]    7
    And Response body parameter should not be EMPTY:    [data][attributes][description]
    And Response body parameter should not be EMPTY:    [data][attributes][productAbstractSku]
...
Request_product_concrete_with_included_bundled_products
    ...
    ...    [data][relationships][bundled-products][data][0][id]
    ...    ${bundle_product.concrete.product_3_sku}
    ...    ${bundle_product.concrete.product_2_sku}
    ...    ${bundle_product.concrete.product_1_sku}
    And Response body parameter should be in:
    ...    [data][relationships][bundled-products][data][1][id]
    ...    ${bundle_product.concrete.product_3_sku}
    ...    ${bundle_product.concrete.product_2_sku}
    ...    ${bundle_product.concrete.product_1_sku}
    And Response body parameter should be in:
    ...    [data][relationships][bundled-products][data][2][id]
    ...    ${bundle_product.concrete.product_3_sku}
    ...    ${bundle_product.concrete.product_2_sku}
    ...    ${bundle_product.concrete.product_1_sku}
...
Request_product_concrete_with_included_bundled_products_concrete_products_and_abstract_products
    When I send a GET request:
    ...    /concrete-products/${bundle_product.concrete.product_4_sku}?include=bundled-products,concrete-products,abstract-products
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response body parameter should be:    [data][type]    concrete-products
    And Response body parameter should be:    [data][id]    ${bundle_product.concrete.product_4_sku}
    ...
    And Response body parameter should be:
    ...    [data][relationships][abstract-products][data][0][id]
    ...    ${bundle_product.abstract.sku}
    And Response should contain the array of a certain size:    [data][relationships][bundled-products][data]    3
    And Response body parameter should be in:
    ...    [data][relationships][bundled-products][data][0][id]
    ...    ${bundle_product.concrete.product_3_sku}
