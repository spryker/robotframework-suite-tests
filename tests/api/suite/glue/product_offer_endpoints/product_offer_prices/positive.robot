...
Get_concrete_product_without_offers_prices
    ...
    ...    /concrete-products/${bundle_product.concrete.product_1_sku}/product-offers?include=product-offer-prices
...
Get_all_concrete_product_offer_info_with_product_offer_prices_and_product_offer_availabilities_and_merchants_included
    When I send a GET request:
    ...    /concrete-products/${abstract_product.product_with_concrete_offers.concrete_sku}/product-offers?include=product-offer-prices,merchants
    Then Response status code should be:    200
    And Response reason should be:    OK
...
Get_all_product_offer_info_with_product_offer_prices_and_merchants_included
    ...
    ...    [data][attributes][merchantReference]
    ...    ${merchants.spryker.merchant_reference}
...
Get_product_offer_price_with_gross_eur_volume_prices
    When I send a GET request:
    ...    /product-offers/${offer_with_volume_price_gross_net_prices}/product-offer-prices?priceMode=${mode.gross}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    ...
    ...    [data]
    ...    [attributes][prices][0][volumePrices][0][grossAmount]
    ...    int
    And Each array element of array in response should contain nested property with datatype:
    ...    [data]
    ...    [attributes][prices][0][volumePrices][0][netAmount]
    ...    int
    And Each array element of array in response should contain nested property with datatype:
    ...    [data]
    ...    [attributes][prices][0][volumePrices][0][quantity]
    ...    int
...
Get_product_offer_price_with_net_eur_volume_prices
    When I send a GET request:
    ...    /product-offers/${offer_with_volume_price_gross_net_prices}/product-offer-prices?priceMode=${mode.net}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][0][id]    ${offer_with_volume_price_gross_net_prices}
...
Get_product_offer_price_with_gross_chf
    When I send a GET request:
    ...    /product-offers/${offer_with_volume_price_gross_net_prices}/product-offer-prices?currency=${currency.chf.code}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][0][id]    ${offer_with_volume_price_gross_net_prices}
...
Get_product_offer_price_with_net_chf
    When I send a GET request:
    ...    /product-offers/${offer_with_volume_price}/product-offer-prices?currency=${currency.chf.code}&priceMode=${mode.net}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
