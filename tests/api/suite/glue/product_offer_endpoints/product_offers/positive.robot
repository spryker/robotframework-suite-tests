...
Get_all_concrete_product_offer_info_with_product_offer_prices_and_product_offer_availabilities_and_merchants_included
    ...
    ...    /concrete-products/${abstract_product.product_with_concrete_offers.concrete_sku}/product-offers?include=product-offer-prices,product-offer-availabilities,merchants
    Then Response status code should be:    200
    And Response reason should be:    OK
...
Get_all_product_offer_info_with_product_offer_prices_and_product_offer_availabilities_and_merchants_included
    ...
    When I send a GET request:
    ...    /product-offers/${offer_with_merchant_sku}?include=product-offer-prices,product-offer-availabilities,merchants
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
...
Get_product_offer_with_gross_eur
    ...
    And Response body parameter should be:
    ...    [included][0][attributes][prices][0][currency][code]
    ...    ${currency.eur.code}
    And Response body parameter should be:
    ...    [included][0][attributes][prices][0][currency][name]
    ...    ${currency.eur.name}
    And Response body parameter should be:
    ...    [included][0][attributes][prices][0][currency][symbol]
    ...    ${currency.eur.symbol}
...
Get_product_offer_with_gross_chf
    When I send a GET request:
    ...    /product-offers/${active_offer}?include=product-offer-prices&currency=${currency.chf.code}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][id]    ${active_offer}
...
Get_product_offer_with_net_chf
    When I send a GET request:
    ...    /product-offers/${active_offer}?include=product-offer-prices&priceMode=${mode.net}&currency=${currency.chf.code}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][id]    ${active_offer}
