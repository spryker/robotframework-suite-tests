...
Get_upselling_products
    ...
    ...    ${product_related_product_with_upselling_relation.sku}
    ...
    ...    ${product_related_product_with_upselling_relation.name}
    ...
    ...    [data][0][attributes][superAttributesDefinition]
    ...    0
...
Get_upselling_products_for_guest_cart_plus_includes
    ...
    ...    AND    Response status code should be:    201
    When I send a GET request:
    ...    /guest-carts/${guest_cart_id}/up-selling-products?include=abstract-product-prices,abstract-product-image-sets,concrete-products,abstract-product-availabilities,product-labels,product-tax-sets,product-options,product-reviews,category-nodes
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response should contain the array larger than a certain size:    [data]    0
