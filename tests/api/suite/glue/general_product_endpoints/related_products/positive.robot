...
Product_has_related_products
    ...
    ...    /abstract-products/${product_with_relations.has_related_products.sku}/related-products
    ...
    ...    ${product_related_product_with_related_relation.sku}
    ...
    ...    ${product_related_product_with_related_relation.name}
...
Product_has_related_products_with_includes
    ...
    When I send a GET request:
    ...    /abstract-products/${product_with_relations.has_related_products.sku}/related-products?include=product-labels
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response should contain the array larger than a certain size:    [data]    0
    ...
    And Response body has correct self link
    And Response should contain the array larger than a certain size:
    ...    [data][8][relationships][product-labels][data]
    ...    0
