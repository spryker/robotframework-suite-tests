...
Create_quote_request
    ...
    ...    /carts/${cart_id}/items
    ...    {"data": {"type": "items","attributes": {"sku": "${concrete.available_product.with_stock_and_never_out_of_stock.sku_1}","quantity": 1}}}
    And I send a POST request:
    ...    /carts/${cart_id}/items
    ...    {"data": {"type": "items","attributes": {"sku": "${concrete.available_product.with_stock_and_never_out_of_stock.sku_2}","quantity": 1}}}
    When I send a POST request:
    ...    /quote-requests
    ...
    ...    [data][attributes][shownVersion][cart][totals][taxTotal][amount]
    ...    1
    And Response body parameter should be greater than:
    ...    [data][attributes][shownVersion][cart][totals][subtotal]
    ...    1
    And Response body parameter should be greater than:
    ...    [data][attributes][shownVersion][cart][totals][grandTotal]
    ...    1
    And Response body parameter should be greater than:
    ...    [data][attributes][shownVersion][cart][totals][priceToPay]
    ...    1
    ...
    ...    [data][attributes][shownVersion][cart][items][0][groupKey]
    ...    ${concrete.available_product.with_stock_and_never_out_of_stock.sku_1}
    And Response body parameter should contain:
    ...    [data][attributes][shownVersion][cart][items][1][groupKey]
    ...    ${concrete.available_product.with_stock_and_never_out_of_stock.sku_2}
    And Each array element of array in response should contain property:
    ...    [data][attributes][shownVersion][cart][items]
    ...    productOfferReference
    And Each array element of array in response should contain property:
    ...    [data][attributes][shownVersion][cart][items]
    ...    merchantReference
    And Response body parameter should be:
    ...    [data][attributes][shownVersion][cart][items][0][sku]
    ...    ${concrete.available_product.with_stock_and_never_out_of_stock.sku_1}
    And Response body parameter should be:
    ...    [data][attributes][shownVersion][cart][items][1][sku]
    ...    ${concrete.available_product.with_stock_and_never_out_of_stock.sku_2}
...
Create_quote_request_with_included_customers_&_comapny_users_&_company_business_units_and_concrete_products
    ...
    ...    {"data": {"type": "items","attributes": {"sku": "${concrete.available_product.with_stock_and_never_out_of_stock.sku_2}","quantity": 1}}}
    When I send a POST request:
    ...    /quote-requests?include=customers,company-users,company-business-units,concrete-products
    ...    {"data":{"type":"quote-requests","attributes":{"cartUuid":"${cart_id}","meta":{"purchase_order_number":"${quote_request.purchase_order_number}","delivery_date":"${quote_request.delivery_date}","note":"${quote_request.note}"}}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    ...
    ...    [data][relationships][company-business-units][data]
    ...    1
    ...
    ...    [data][relationships][concrete-products][data]
    ...    1
...
Create_quote_request_without_delivery_date_and_note
    ...
    When I send a POST request:
    ...    /quote-requests
    ...    {"data":{"type":"quote-requests","attributes":{"cartUuid":"${cart_id}","meta":{"purchase_order_number":"${quote_request.purchase_order_number}"}}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][type]    quote-requests
...
Create_quote_request_with_empty_meta_data
    ...
    When I send a POST request:
    ...    /quote-requests
    ...    {"data":{"type":"quote-requests","attributes":{"cartUuid":"${cart_id}","meta":{"purchase_order_number":"","delivery_date":"","note":""}}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][type]    quote-requests
...
Retrieves_quote_request_list
    ...
    And Each array element of array in response should contain nested property with value:
    ...    [data]
    ...    [attributes][shownVersion][cart][priceMode]
    ...    ${mode.gross}
    And Each array element of array in response should contain nested property with value:
    ...    [data]
    ...    [attributes][shownVersion][cart][store]
    ...    ${store.de}
    And Each array element of array in response should contain nested property with value:
    ...    [data]
    ...    [attributes][shownVersion][cart][currency]
    ...    ${currency.eur.code}
    And Each array element of array in response should contain nested property:
    ...    [data]
    ...    [attributes][shownVersion][cart][totals]
    ...    expenseTotal
    And Each array element of array in response should contain nested property:
    ...    [data]
    ...    [attributes][shownVersion][cart][totals]
    ...
    ...    [data]
    ...    [attributes][shownVersion][cart][totals][subtotal]
    ...    0
    And Each array element of array in response should be greater than:
    ...    [data]
    ...    [attributes][shownVersion][cart][totals][grandTotal]
    ...    0
    And Each array element of array in response should be greater than:
    ...    [data]
    ...    [attributes][shownVersion][cart][totals][priceToPay]
    ...    0
    And Each array element of array in response should contain nested property:
    ...    [data]
    ...    [attributes][shownVersion][cart]
    ...    billingAddress
    And Each array element of array in response should contain nested property:
    ...    [data]
    ...    [attributes][shownVersion][cart]
    ...
    And Each array element of array in response should contain nested property:
    ...    [data]
    ...    [attributes][shownVersion][cart][items][0]
    ...    groupKey
    And Each array element of array in response should contain nested property:
    ...    [data]
    ...    [attributes][shownVersion][cart][items][0]
...
Retrieves_quote_request_by_requestId
    ...
    And Response body parameter should contain:
    ...    [data][attributes][shownVersion][cart][items][0]
    ...    productOfferReference
    And Response body parameter should contain:
    ...    [data][attributes][shownVersion][cart][items][0]
    ...    merchantReference
...
Retrieve_quote_request_version
    ...
    ...    /quote-requests/${quoteRequestId}?quoteRequestVersionReference=${quote_request_version}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][type]    quote-requests
