...
Get_category_trees
    ...
    ...    ${category_nodes_storage_name}
    And Response body parameter should be:
    ...    [data][0][attributes][categoryNodesStorage][1][url]
    ...    ${category_nodes_storage_url}
    ...
    And Response body parameter should be:
    ...    [data][0][attributes][categoryNodesStorage][1][children][0][name]
    ...    ${subcategory_nodes_storage_name}
    And Response body parameter should be:
    ...    [data][0][attributes][categoryNodesStorage][1][children][0][url]
    ...    ${subcategory_nodes_storage_url}
