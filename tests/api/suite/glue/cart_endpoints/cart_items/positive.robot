...
Add_one_item_to_cart
    ...
    ...    /carts/${cart_id}/items
    ...    {"data": {"type": "items","attributes": {"sku": "${product_availability.concrete_available_with_stock_and_never_out_of_stock_sku}","quantity": 1}}}
...
Add_two_items_to_cart_with_included_items_concrete_products_and_abstract_products
    ...
    ...    AND    Save value to a variable:    [data][id]    cart_id
    When I send a POST request:
    ...    /carts/${cart_id}/items?include=items,concrete-products,abstract-products
    ...    {"data": {"type": "items","attributes": {"sku": "${product_availability.concrete_available_with_stock_and_never_out_of_stock_sku}","quantity": 2}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][id]    ${cart_id}
    ...
    ...    ${product_availability.abstract_available_with_stock_and_never_out_of_stock}
...
Add_five_items_to_cart_with_included_cart_rules_and_promotional_items
    ...
    ...    AND    Save value to a variable:    [data][id]    cart_id
    When I send a POST request:
    ...    /carts/${cart_id}/items?include=cart-rules,promotional-items
    ...    {"data": {"type": "items","attributes": {"sku": "${concrete_product_with_concrete_product_alternative.sku}","quantity": 5}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][id]    ${cart_id}
...
Add_item_with_storage_category_and_2_discounts
    ...
    When I send a POST request:
    ...    /carts/${cart_id}/items
    ...    {"data": {"type": "items","attributes": {"sku": "${concrete_product.product_without_relations}","quantity": 2}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][id]    ${cart_id}
    ...
    ...    ${discount_concrete_product.product_1.total_sum_of_discounts}
    ...
    ...    ${discount_concrete_product.product_1.with_discount_20_percentage_off_storage}
    ...
    ...    ${discount_concrete_product.product_1.with_discount_10_percentage_off_minimum_order}
...
Change_item_qty_in_cart
    ...
    ...    /carts/${cart_id}/items/${item_uid}?include=items
