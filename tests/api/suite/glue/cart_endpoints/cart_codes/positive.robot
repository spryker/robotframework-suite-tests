...
Add_gift_card_code_to_cart
    ...
    ...    /carts/${cart_id}/cart-codes?include=gift-cards
    ...    {"data": {"type": "cart-codes","attributes": {"code": "normal_${random}"}}}
    And Response status code should be:    201
...
Add_gift_card_code_to_the_guest_cart
    ...
    When I send a POST request:
    ...    /guest-carts/${guestcart_id}/cart-codes?include=gift-cards
    ...    {"data": {"type": "cart-codes","attributes": {"code": "guest_${random}"}}}
...
Delete_gift_card_code_from_the_guest_cart
    ...
    ...    Create a guest cart:
    ...    ${random}
    ...    ${concrete_available_product.with_label}
    ...    1
    ...    AND
    ...
    ...    delete_guest_${random}
    ...    ${gift_card.amount}
    ...    AND
    ...    I send a POST request:
    ...    /guest-carts/${guestcart_id}/cart-codes?include=gift-cards
    ...    {"data": {"type": "cart-codes","attributes": {"code": "delete_guest_${random}"}}}
    ...    AND
...
Add_gift_card_code_to_empty_cart
    ...
    ...    AND    Save value to a variable:    [data][id]    cart_id
    When I send a POST request:
    ...    /carts/${cart_id}/cart-codes
    ...    {"data": {"type": "cart-codes","attributes": {"code": "empty_${random}"}}}
    And Response status code should be:    201
    And Response body parameter should be:    [data][type]    carts
    And Response body parameter should not be EMPTY:    [data][id]
    And Response body parameter should not be EMPTY:    [data][id]
