...
Get_sales_units_for_product_with_sales_units
    ...
    ...    [data]
    ...    ${concrete_product.random_weight.qty_of_units}
    ...
    ...    int
    And Each array element of array in response should contain nested property with datatype in:
    ...    [data]
    ...
    And Each array element of array in response should contain property with value in:
    ...    [data]
    ...    [attributes][productMeasurementUnitCode]
    ...    ${packaging_unit.m}
    ...    ${packaging_unit.cm}
    And Response body has correct self link
...
Get_sales_units_for_product_with_measurement_units_include
    ...
    ...    /concrete-products/${concrete_product.random_weight.sku}/sales-units?include=product-measurement-units
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response should contain the array of a certain size:
    ...
    And Each array element of array in response should contain property with value:    [data]    type    sales-units
    And Response body has correct self link
    And Each array element of array in response should a nested array of a certain size:
    ...    [data]
    ...    [relationships]
    ...    1
    And Response should contain the array of a certain size:
