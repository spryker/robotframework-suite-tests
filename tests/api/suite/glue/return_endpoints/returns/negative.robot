...
Create_a_return_with_Invalid_access_token
    ...
    ...    /returns
    ...    {"data":{"type":"returns","attributes":{"store":"${store.de}","returnItems":[{"salesOrderItemUuid":"${random}","reason":"${return_reason_damaged}"}]}}}
...
Create_return_for_order_item_that_cannot_be_returned
    ...
    When I send a POST request:
    ...    /returns
    ...    {"data":{"type":"returns","attributes":{"store":"${store.de}","returnItems":[{"salesOrderItemUuid":"${Uuid}","reason":"${return_reason_damaged}"}]}}}
...
Create_a_return_with_order_is_not_returnable_for_merchant
    ...
    When I send a POST request:
    ...    /returns
    ...    {"data":{"type":"returns","attributes":{"store":"${store.de}","returnItems":[{"salesOrderItemUuid":"${returnableSalesOrderItemUuid}","reason":"${return_reason_damaged}"}]}}}
    Then Response status code should be:    422
    And Response reason should be:    Unprocessable Content
    And Response should return error message:    "Return cant be created."
    And Response should return error code:    3601
...
Create_return_without_returnItems_uuid
    ...
    When I send a POST request:
    ...    /returns
    ...    {"data":{"type":"returns","attributes":{"store":"${store.de}","returnItems":[{"salesOrderItemUuid":"","reason":"${return_reason_damaged}"}]}}}
    Then Response status code should be:    422
    And Response reason should be:    Unprocessable Content
    And Response should return error message:    "Return cant be created."
    And Response should return error code:    3601
...
Create_return_without_returnItems_reason
    ...
    When I send a POST request:
    ...    /returns
    ...    {"data":{"type":"returns","attributes":{"store":"${store.de}","returnItems":[{"salesOrderItemUuid":"920fc22f-3fb6-53ec-bc5e-c4d321115462","reason":""}]}}}
    Then Response status code should be:    422
    And Response reason should be:    Unprocessable Content
    And Response should return error message:    "Return cant be created."
    And Response should return error code:    3601
