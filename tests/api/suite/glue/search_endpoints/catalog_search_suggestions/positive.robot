...
Get_search_suggestions_with_discontinued_product_sku
    ...
    ...    /catalog-search-suggestions?q=${concrete_product_with_concrete_product_alternative.sku}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    ...
    ...    ${concrete_product_with_concrete_product_alternative.name}
    And Response body parameter should be:
    ...    [data][0][attributes][abstractProducts][0][abstractSku]
    ...    ${abstract_product_with_alternative.sku}
...
Get_search_suggestions_with_all_attributes_data
    When I send a GET request:
    ...    /catalog-search-suggestions?q=${concrete_product_with_concrete_product_alternative.name_lower_case}
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    And Response body parameter should be:
    ...    [data][0][attributes][completion]
    ...    ${concrete_product_with_concrete_product_alternative.name_lower_case}
...
Get_search_suggestions_with_abstract_product_sku
    ...
    And Response body parameter should be:
    ...    [data][0][attributes][abstractProducts][0][abstractName]
    ...    ${abstract_available_product_with_stock.name}
    And Response body parameter should be:
    ...    [data][0][attributes][abstractProducts][0][abstractSku]
...
Get_search_suggestions_with_cms_pages
    ...
    And Response body parameter should be:
    ...    [data][0][attributes][completion]
    ...    ${cms_pages.first_cms_page.name_lower_case}
    And Response body parameter should be:
    ...    [data][0][attributes][cmsPages][0][name]
    ...    ${cms_pages.first_cms_page.name}
    And Response body parameter should be:
    ...    [data][0][attributes][cmsPages][0][url]
    ...    ${cms_pages.first_cms_page.url_en}
    And Response body has correct self link
...
Get_search_suggestions_with_cms_page_collection
    ...
    ...    ${cms_page_collection_name}
    And Response body parameter should be:
    ...    [data][0][attributes][cmsPageCollection][0][url]
    ...    ${cms_page_collection_url}
    And Response body has correct self link
...
Get_search_suggestions_with_abstract_product_sku_and_included_abstract_products
    When I send a GET request:
    ...    /catalog-search-suggestions?q=${abstract_available_product_with_stock.sku}&include=abstract-products
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    ...
    ...    ${abstract_available_product_with_stock.description}
    And Response body parameter should be:
    ...    [included][0][attributes][attributes][internal_memory]
    ...    ${internal_memory}
    ...
    And Response body parameter should be:
    ...    [included][0][attributes][attributes][display_technology]
    ...    ${display_technology}
    ...
    ...    [included][0][attributes][superAttributesDefinition]
    ...    3
    ...
    ...    ${concrete_available_product.sku}
    And Response should contain the array of a certain size:
    ...
    ...    ${concrete_available_product.meta_keywords}
    And Response body parameter should be:
    ...    [included][0][attributes][metaDescription]
    ...    ${concrete_available_product.meta_description}
    And Response body has correct self link
