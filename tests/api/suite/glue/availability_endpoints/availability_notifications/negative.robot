...
Get_availability_notifications_without_customerId
    ...
    ...  AND    I send a POST request:    /availability-notifications    {"data": {"type": "availability-notifications","attributes": {"sku": "${product_with_alternative.concrete_sku}","email": "${yves_second_user}"}}}
