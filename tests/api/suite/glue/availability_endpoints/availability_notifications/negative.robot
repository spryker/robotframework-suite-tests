...
Subscribe_to_availability_notifications_with_empty_type
    ...
    ...    {"data": {"type": "","attributes": {"sku": "${product_with_alternative.concrete_sku}","email": "${yves_user.email}"}}}
...
Subscribe_to_availability_notifications_without_type
    When I send a POST request:
    ...    /availability-notifications
    ...    {"data": {"attributes": {"sku": "${product_with_alternative.concrete_sku}","email": "${yves_user.email}"}}}
    Then Response status code should be:    400
    And Response reason should be:    Bad Request
...
Subscribe_to_availability_notifications_with_invalid_email
    When I send a POST request:
    ...    /availability-notifications
    ...    {"data": {"type": "availability-notifications","attributes": {"sku": "${product_with_alternative.concrete_sku}","email": "gmail"}}}
