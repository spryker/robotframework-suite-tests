...
Retrieves_merchant_addresses
    ...
    ...    [data][0][attributes][addresses][0][city]
    ...    ${merchants.sony_experts.addresses.city_munchen}
...
Retrieves_merchant_with_include_merchant_addresses
    ...
    ...    [data][relationships][merchant-addresses][data]
    ...    type
    And Each array element of array in response should contain property:
    ...    [data][relationships][merchant-addresses][data]
    ...    id
    ...
    ...    longitude
    And Response body parameter should be:
    ...    [included][0][attributes][addresses][0][countryName]
    ...    ${default.country}
    And Response body parameter should be:
    ...    [included][0][attributes][addresses][0][city]
    ...    ${merchants.sony_experts.addresses.city_munchen}
    And Response body parameter should be:
    ...    [included][0][attributes][addresses][0][address1]
    ...    ${merchants.sony_experts.addresses.address1}
