...
Retrieves_merchant_opening_hours
    ...
    ...    [data]
    ...    [attributes][weekdaySchedule]
    ...    list
    And Each array element of array in response should contain nested property with datatype:
    ...    [data]
    ...    [attributes][dateSchedule]
    ...    list
...
Retrieves_merchant_with_include_merchant_opening_hours
    ...
    ...    /merchants/${merchants.sony_experts.merchant_reference}?include=merchant-opening-hours
    Then Response status code should be:    200
    And Response reason should be:    OK
    ...
    ...    [data][relationships][merchant-opening-hours][data]
    ...    type
    And Each array element of array in response should contain property:
    ...    [data][relationships][merchant-opening-hours][data]
    ...    id
    ...
    ...    [included][0][attributes][weekdaySchedule][0][timeFrom]
    ...    07:00:00.000000
    ...
    And Response body parameter should be:
    ...    [included][0][attributes][dateSchedule][0][noteGlossaryKey]
    ...    "New Years Day"
