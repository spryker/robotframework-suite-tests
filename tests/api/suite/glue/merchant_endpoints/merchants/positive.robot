...
Retrieves_a_merchant_by_id
    ...
    ...    [data][attributes][merchantName]
    ...    ${merchants.sony_experts.merchant_name}
    And Response body parameter should be:    [data][attributes][merchantUrl]    ${merchants.sony_experts.merchant_url}
    And Response body parameter should be:
    ...    [data][attributes][contactPersonRole]
    ...    ${merchants.sony_experts.contact_person_role}
    And Response body parameter should be:
    ...    [data][attributes][contactPersonTitle]
    ...    ${merchants.sony_experts.contact_person_title}
    And Response body parameter should be:
    ...    [data][attributes][contactPersonFirstName]
    ...    ${merchants.sony_experts.contact_person_first_name}
    And Response body parameter should be:
    ...    [data][attributes][contactPersonLastName]
    ...    ${merchants.sony_experts.contact_person_last_name}
    And Response body parameter should be:
    ...    [data][attributes][contactPersonPhone]
    ...    ${merchants.sony_experts.contact_person_phone}
