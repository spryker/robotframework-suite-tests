...
Abstract_image_sets_with_1_concrete
    ...
    ...    /abstract-products/${product_availability.abstract_available_with_stock_and_never_out_of_stock}/abstract-product-image-sets
...
Abstract_image_sets_with_3_concretes
    When I send a GET request:
    ...    /abstract-products/${abstract_product_with_variants.concretes_3}/abstract-product-image-sets
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
