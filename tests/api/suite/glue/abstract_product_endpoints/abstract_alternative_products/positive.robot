...
Product_has_abstract_alternative
    ...
    ...    /concrete-products/${product_with_alternative.concrete_sku}/abstract-alternative-products
...
Product_has_abstract_alternative_with_includes
    When I send a GET request:
    ...    /concrete-products/${product_with_alternative.concrete_sku}/abstract-alternative-products?include=abstract-product-image-sets,abstract-product-availabilities,abstract-product-prices,category-nodes
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response should contain the array of a certain size:    [data]    1
...
Product_has_no_abstract_alternative
    When I send a GET request:
    ...    /concrete-products/${bundle_product.concrete.product_1_sku}/abstract-alternative-products
