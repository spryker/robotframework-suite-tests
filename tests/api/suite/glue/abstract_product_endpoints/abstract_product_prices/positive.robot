...
Abstract_prices_detault_only
    ...
    ...    /abstract-products/${abstract_product_with_variants.concretes_3}/abstract-product-prices
...
Abstract_volume_prices
    When I send a GET request:
    ...    /abstract-products/${abstract_product.product_with_volume_prices.sku}/abstract-product-prices
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
...
Abstract_prices_original_price
    [Tags]    none
    When I send a GET request:
    ...    /abstract-products/${abstract_product.product_with_original_prices.sku}/abstract-product-prices
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
