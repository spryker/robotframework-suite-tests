...
Product_is_available_with_stock_and_never_out_of_stock
    ...
    ...    /abstract-products/${product_availability.abstract_available_with_stock_and_never_out_of_stock}/abstract-product-availabilities
...
Product_is_available_with_stock
    When I send a GET request:
    ...    /abstract-products/${abstract_available_product_with_stock.sku}/abstract-product-availabilities
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][0][type]    abstract-product-availabilities
...
Product_is_available_never_out_of_stock
    When I send a GET request:
    ...    /abstract-products/${product_availability.abstract_available_product_with_no_stock_and_never_out_of_stock}/abstract-product-availabilities
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][0][type]    abstract-product-availabilities
    And Response body parameter should be:
    ...    [data][0][id]
    ...    ${product_availability.abstract_available_product_with_no_stock_and_never_out_of_stock}
    And Response body parameter should be:    [data][0][attributes][availability]    True
...
Product_is_unavailable
    When I send a GET request:
    ...    /abstract-products/${product_availability.abstract_unavailable_product}/abstract-product-availabilities
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][0][type]    abstract-product-availabilities
...
Product_is_available_with_3_concrete_stocks_combined
    ...
    When I send a GET request:
    ...    /abstract-products/${abstract_product_with_variants.concretes_3}/abstract-product-availabilities
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][0][type]    abstract-product-availabilities
