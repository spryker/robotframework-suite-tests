...
Adding_item_in_wishlist
    ...
    ...    {"data": {"type": "wishlist-items","attributes": {"sku": "${abstract_product_with_merchant.concrete_sku}"}}}
...
Adding_item_in_wishlist_with_offer
    ...
    When I send a POST request:
    ...    /wishlists/${wishlist_id}/wishlist-items
    ...    {"data": {"type": "wishlist-items","attributes": {"sku": "${concrete_available_product.with_offer}", "productOfferReference": "offer37"}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    And Save value to a variable:    [data][id]    wishlist_items_id
    And Response body parameter should not be EMPTY:    [data][attributes][sku]
...
Adding_multiple_variant_of_abstract_product_in_wishlist
    ...
    When I send a POST request:
    ...    /wishlists/${wishlist_id}/wishlist-items
    ...    {"data": {"type": "wishlist-items","attributes": {"sku": "${abstract_product_with_variants.variant1_sku}"}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    When I send a POST request:
    ...    /wishlists/${wishlist_id}/wishlist-items
    ...    {"data": {"type": "wishlist-items","attributes": {"sku": "${abstract_product_with_variants.variant2_sku}"}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    And Save value to a variable:    [data][id]    wishlist_items_id
    And Response body parameter should not be EMPTY:    [data][attributes][sku]
