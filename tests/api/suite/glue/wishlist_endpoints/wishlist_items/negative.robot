...
Adding_item_with_abstract_sku
    ...
    ...    /wishlists/${wishlist_reference_id}/wishlist-items
    ...    {"data": {"type": "wishlist-items","attributes": {"sku": "${abstract_available_product_with_stock.sku}"}}}
...
Adding_item_with_invalid_sku
    ...
    When I send a POST request:
    ...    /wishlists/${wishlist_reference_id}/wishlist-items
    ...    {"data": {"type": "wishlist-items","attributes": {"sku": "SK123445666"}}}
    Then Response status code should be:    422
    And Response reason should be:    Unprocessable Content
    And Response should return error code:    206
    And Response should return error message:    "Cant add an item."
...
Adding_item_with_empty_sku
    ...
    When I send a POST request:
    ...    /wishlists/${wishlist_reference_id}/wishlist-items
    ...    {"data": {"type": "wishlist-items","attributes": {"sku": ""}}}
    Then Response status code should be:    422
    And Response reason should be:    Unprocessable Content
...
Adding_item_with_invalid_wishilist_id
    ...
    ...    AND    I set Headers:    Authorization=${token}
    When I send a POST request:
    ...    /wishlists/Mywishlist/wishlist-items
    ...    {"data": {"type": "wishlist-items","attributes": {"sku": "${abstract_available_product_with_stock.concrete_sku}"}}}
    Then Response status code should be:    422
    And Response reason should be:    Unprocessable Content
    And Response should return error code:    206
    And Response should return error message:    "Cant add an item."
...
Adding_item_with_deactivated_item_sku
    ...
    When I send a POST request:
    ...    /wishlists/${wishlist_reference_id}/wishlist-items
    ...    {"data": {"type": "wishlist-items","attributes": {"sku": "Demo-SKU-Id"}}}
    Then Response status code should be:    422
    And Response reason should be:    Unprocessable Content
    And Response should return error code:    206
    And Response should return error message:    "Cant add an item."
...
Deleting_item_in_wishlist_by_invalid_Access_Token
    ...
    ...    /wishlists/mywishlist/wishlist-items/${abstract_available_product_with_stock.concrete_sku}
    Then Response status code should be:    401
    And Response reason should be:    Unauthorized
    And Response should return error code:    001
    And Response should return error message:    Invalid access token.
...
Delete_wishlist_item_from_already_deleted_wishlist
    ...
    When I send a DELETE request:
    ...    /wishlists/${wishlist_reference_id}/wishlist-items/${abstract_available_product_with_stock.concrete_sku}
    Then Response status code should be:    404
    And Response reason should be:    Not Found
    And Response should return error code:    201
    And Response should return error message:    "Cant find wishlist."
...
Deleting_concrete_product_by_abstract_product_sku
    ...
    ...    AND    Response reason should be:    Created
    When I send a DELETE request:
    ...    /wishlists/${wishlist_id}/wishlist-items/${abstract_available_product_with_stock.sku}
    Then Response status code should be:    404
    And Response reason should be:    Not Found
