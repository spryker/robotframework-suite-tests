...
Get_order_by_order_id
    ...
    And Response body parameter should be greater than:
    ...    [data][attributes][expenses][0][unitPriceToPayAggregation]
    ...    0
    And Response body parameter should be greater than:
    ...    [data][attributes][expenses][0][sumPriceToPayAggregation]
    ...    0
...
Get_order_by_order_id_with_bundle_product
    ...
    And Response body parameter should be:
    ...    [data][attributes][items][0][name]
    ...    ${bundled_product.concrete.product_2_name}
    And Response body parameter should be:
    ...    [data][attributes][items][0][sku]
    ...    ${bundled_product.concrete.product_2_sku}
    And Response body parameter should be:
    ...    [data][attributes][items][1][name]
    ...    ${bundled_product.concrete.product_3_name}
    And Response body parameter should be:
    ...    [data][attributes][items][1][sku]
    ...    ${bundled_product.concrete.product_3_sku}
    And Response body parameter should be:
    ...    [data][attributes][items][2][name]
    ...    ${bundled_product.concrete.product_4_name}
    And Response body parameter should be:
    ...    [data][attributes][items][2][sku]
    ...    ${bundled_product.concrete.product_4_sku}
    #bundleItems
    And Response body parameter should be:
    ...    [data][attributes][bundleItems][0][name]
    ...    ${bundled_product.concrete.product_1_name}
    And Response body parameter should be:
    ...    [data][attributes][bundleItems][0][sku]
    ...    ${bundled_product.concrete.product_1_sku}
...
Get_order_by_order_id_with_sales_unit
    ...
    And Response body parameter should be:
    ...    [data][attributes][items][0][name]
    ...    ${concrete_product.random_weight.name}
    And Response body parameter should be:
    ...    [data][attributes][items][0][sku]
    ...    ${concrete_product.random_weight.sku}
    And Response body parameter should be:    [data][attributes][items][0][quantity]    1
    ...
    ...    ${concrete_product.random_weight.conversion}
    And Response body parameter should be:
    ...    [data][attributes][items][0][salesUnit][precision]
    ...    ${concrete_product.random_weight.precision}
    And Response body parameter should be:
    ...
    ...    ${packaging_unit.m}
    And Response body parameter should be:
    ...    [data][attributes][items][0][amount]
    ...    ${concrete_product.random_weight.amount}
...
Get_order_by_order_id_with_different_items_and_quantity
    ...
    And Response body parameter should be:
    ...    [data][attributes][items][1][name]
    ...    ${concrete_product_with_alternative.name}
    And Response body parameter should be:
    ...    [data][attributes][items][1][sku]
    ...    ${concrete_product_with_alternative.sku}
...
Get_order_by_order_id_with_split_shipment_&_include
    ...
    And Response body parameter should be:
    ...    [included][1][attributes][requestedDeliveryDate]
    ...    ${shipment.delivery_date}
    And Response body parameter should be:
...
Get_order_with_configurable_bundle
    ...
    #billingAddress
    And Response body parameter should be:
    ...    [data][attributes][billingAddress][salutation]
    ...    ${yves_second_user.salutation}
    And Response body parameter should be:
    ...    [data][attributes][billingAddress][firstName]
    ...    ${yves_second_user.first_name}
    And Response body parameter should be:    [data][attributes][billingAddress][middleName]    None
    And Response body parameter should be:
    ...    [data][attributes][billingAddress][lastName]
    ...
    ...    ${yves_second_user.salutation}
    And Response body parameter should be:
    ...    [data][attributes][shippingAddress][firstName]
    ...    ${yves_second_user.first_name}
    And Response body parameter should be:    [data][attributes][shippingAddress][middleName]    None
    And Response body parameter should be:
    ...    [data][attributes][shippingAddress][lastName]
    ...    ${yves_second_user.last_name}
    And Response body parameter should be:    [data][attributes][shippingAddress][address1]    ${default.address1}
    And Response body parameter should be:    [data][attributes][shippingAddress][address2]    ${default.address2}
    And Response body parameter should be:    [data][attributes][shippingAddress][address3]    ${default.address3}
    ...
    And Response body parameter should be:
    ...    [data][attributes][items][0][name]
    ...    ${concrete.available_product.with_stock.name2}
    And Response body parameter should be:
    ...    [data][attributes][items][0][sku]
    ...    ${concrete.available_product.with_stock.sku2}
    And Response body parameter should be greater than:    [data][attributes][items][0][sumPrice]    0
    And Response body parameter should be:    [data][attributes][items][0][quantity]    1
    And Response body parameter should be greater than:    [data][attributes][items][0][unitGrossPrice]    0
    And Response body parameter should be greater than:    [data][attributes][items][0][sumGrossPrice]    0
    ...
    ...    [data][attributes][items][0][salesOrderConfiguredBundle]
    ...    idSalesOrderConfiguredBundle
    And Response body parameter should be:
    ...    [data][attributes][items][0][salesOrderConfiguredBundle][configurableBundleTemplateUuid]
    ...    ${configurable_bundle_template_2_uuid}
    And Response body parameter should be:
    ...    [data][attributes][items][0][salesOrderConfiguredBundle][name]
    ...    ${configurable_bundle_template_name_2}
    And Response body parameter should be:    [data][attributes][items][0][salesOrderConfiguredBundle][quantity]    1
    And Response body parameter should contain:
    ...    [data][attributes][items][0][salesOrderConfiguredBundleItem]
    ...    idSalesOrderConfiguredBundle
    And Response body parameter should be:
    ...    [data][attributes][items][0][salesOrderConfiguredBundleItem][configurableBundleTemplateSlotUuid]
    ...    ${configurable_bundle_slot_5_uuid}
    And Response should contain the array of a certain size:
    ...    [data][attributes][items][0][metadata][superAttributes]
    ...    2
    And Response body parameter should not be EMPTY:    [data][attributes][items][0][metadata][image]
