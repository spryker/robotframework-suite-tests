...
Get_order_by_order_id
    ...
    And Response body case insensative parameter should be:    [data][attributes][payments][0][paymentMethod]    ${payment.method_name}
    #shipments
...
Get_order_with_gift_card
    ...
    And Response body case insensative parameter should be:    [data][attributes][payments][0][paymentMethod]    ${gift_card.paymentMethod}
    ...
    And Response body case insensative parameter should be:    [data][attributes][payments][1][paymentMethod]    ${payment.method_name}
    #shipments
    And Response body parameter should be:    [data][attributes][shipments][0][shipmentMethodName]    ${shipment.method_name_1}
    And Response body parameter should be:    [data][attributes][shipments][0][carrierName]    ${shipment.carrier_name}
    And Response body parameter should be:    [data][attributes][shipments][0][deliveryTime]    None
