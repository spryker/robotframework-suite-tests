...
ENABLER
 ...
 Get_product_abstract_collection_with_childs:
    ...
    Create dynamic entity configuration relation in Database:    robot-tests-product-abstracts    robot-tests-products    roboTestsConcreteProducts    fk_product_abstract    id_product_abstract
    ...
    And I send a GET request:    /dynamic-entity/robot-tests-product-abstracts?include=roboTestsConcreteProducts
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robot-tests-product-abstracts?include=roboTestsConcreteProducts.roboTestsProductCategories.roboTestsCategories
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    And Response should contain the array of a certain size:   [data]    224
    And Response should contain the array of a certain size:   [data][0]    9
 ...
 Get_product_abstract_with_childs_by_id:
    ...
    ### GET PRODUCT ABSTRACT COLLECTION WITH CHILDS ONE LVEL ###
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robot-tests-product-abstracts/130?include=roboTestsConcreteProducts
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    ...
    ### GET PRODUCT ABSTRACT COLLECTION WITH CHILDS AS TREE ###
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robot-tests-product-abstracts/130?include=roboTestsConcreteProducts.roboTestsProductCategories.roboTestsCategories
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    And Response should contain the array of a certain size:   [data]    9
    And Response should contain the array of a certain size:   [data][roboTestsConcreteProducts]    3
