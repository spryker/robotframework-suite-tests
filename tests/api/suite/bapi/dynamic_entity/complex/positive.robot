...
ENABLER
 ...
 Get_product_abstract_collection_with_childs:
    ...
    Update dynamic entity configuration relation in Database:    products    product-categories    productCategories    fk_product_abstract    id_product
    Update dynamic entity configuration relation in Database:    product-categories    categories    categories    id_category    fk_category
    ...
    And Response should contain the array of a certain size:   [data][0][productAbstractProducts]    1
    ...
    And Each array element of array in response should contain nested property:    [data]    [productAbstractProducts]    id_product
    ...
    And Response should contain the array of a certain size:   [data][0]    9
    And Response should contain the array of a certain size:   [data][0][productAbstractProducts]    1
    And Response should contain the array of a certain size:   [data][0][productAbstractProducts][0][productCategories]    1
    And Response should contain the array of a certain size:   [data][0][productAbstractProducts][0][productCategories][0][categories]    1
 ...
 Get_product_abstract_with_childs_by_id:
    ...
    And Response should contain the array of a certain size:   [data][productAbstractProducts]    3
    And Response body parameter should be:    [data][id_product_abstract]    130
    And Response body parameter should be:    [data][sku]    130
    And Response body parameter should be:    [data][productAbstractProducts][0][fk_product_abstract]    130
    And Response body parameter should be:    [data][productAbstractProducts][1][fk_product_abstract]    130
    And Response body parameter should be:    [data][productAbstractProducts][2][fk_product_abstract]    130
    ...
    And Response should contain the array of a certain size:   [data]    9
    And Response should contain the array of a certain size:   [data][productAbstractProducts]    3
    And Response should contain the array of a certain size:   [data][productAbstractProducts][0][productCategories]    1
    And Response should contain the array of a certain size:   [data][productAbstractProducts][0][productCategories][0][categories]    1
    And Response should contain the array of a certain size:   [data][productAbstractProducts][1][productCategories]    1
    And Response should contain the array of a certain size:   [data][productAbstractProducts][1][productCategories][0][categories]    1
 ...
 Create_and_update_product_abstract_collection_with_child:
    ...
    Delete dynamic entity configuration relation in Database:    robotTestsConcreteProducts
