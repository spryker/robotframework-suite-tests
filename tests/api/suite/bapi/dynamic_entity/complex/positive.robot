...
ENABLER
 ...
 Get_product_abstract_collection_with_childs:
    ...
    And I send a GET request:    /dynamic-entity/robottests-product-abstracts?include=roboTestsConcreteProducts
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robottests-product-abstracts?include=roboTestsConcreteProducts.roboTestsProductCategories.roboTestsCategories
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    And Response should contain the array of a certain size:   [data]    224
    And Response should contain the array of a certain size:   [data][0]    9
