...
Get_country_Collection_with_filter_first_item
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robottests-countries?filter[country.iso2_code]=AC
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    And Response body parameter should be:    [data][0][id_country]    1
    And Response body parameter should be:    [data][0][iso2_code]    AC
...
Get_country_collection_with_filter
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robottests-countries?filter[country.iso2_code]=UA
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
...
Get_country_collection_with_paginations
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robottests-countries?page[offset]=234&page[limit]=2
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
...
Get_country_collection_with_paginations_out_of_items
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robottests-countries?page[offset]=500&page[limit]=10
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    And Response should contain the array of a certain size:   $    1
...
Get_country_by_id
    ...
    ### GET COUNTRY BY ID ###
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robottests-countries/235
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
...
Create_and_update_country:
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a POST request:    /dynamic-entity/robottests-countries   {"data":[{"iso2_code":"XM","iso3_code":"XXM","name":"POST XM"}]}
    ...
    ### UPDATE COUNTRY ###
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PATCH request:    /dynamic-entity/robottests-countries/${xxa_country_id}    {"data":{"iso2_code":"XX","iso3_code":"XXX","name":"Country XX"}}
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robottests-countries/${xxa_country_id}
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    And Response body parameter should be:    [data][iso2_code]    XX
    And Response body parameter should be:    [data][iso3_code]    XXX
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PATCH request:    /dynamic-entity/robottests-countries/${xxa_country_id}    {"data":{"name":"Test Country"}}
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
...
Create_country_collection:
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a POST request:    /dynamic-entity/robottests-countries   {"data":[{"iso2_code":"XA","iso3_code":"XXA","name":"Country XA"},{"iso2_code":"XB","iso3_code":"XXB","name":"Country XB"},{"iso2_code":"XC","iso3_code":"XXC","name":"Country XC","postal_code_regex":"\\d{5}"}]}
    Then Response status code should be:    201
    And Response header parameter should be:    Content-Type    application/json
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PATCH request:    /dynamic-entity/robottests-countries    {"data":[{"id_country":${xxa_country_id},"iso2_code":"XA","iso3_code":"XAA","name":"XAA"},{"id_country":${xxb_country_id},"iso2_code":"XB","iso3_code":"XBB","name":"XBB"},{"id_country":${xxc_country_id},"iso2_code":"XC","iso3_code":"XCC","name":"XCC"}]}
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    And Response body parameter should be:    [data][0][iso2_code]    XA
...
Upsert_country_collection:
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a POST request:    /dynamic-entity/robottests-countries   {"data":[{"iso2_code":"XA","iso3_code":"XAA","name":"PUT XAA"},{"iso2_code":"XB","iso3_code":"XBB","name":"PUT XBB"}]}
    Then Response status code should be:    201
    And Response header parameter should be:    Content-Type    application/json
    And Response body parameter should be:    [data][0][iso2_code]    XA
    And Response body parameter should be:    [data][0][iso3_code]    XAA
    ...
    ## UPSERT ONE COUNTRY ###
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PUT request:    /dynamic-entity/robottests-countries/${xaa_country_id}    {"data":{"iso2_code":"XX","iso3_code":"XXX","name":"Country XXX"}}
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    And Response body parameter should be:    [data][iso2_code]    XX
    And Response body parameter should be:    [data][iso3_code]    XXX
    ...
    ### GET COUNTRY AND VALIDATE DATA ###
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robottests-countries/${xaa_country_id}
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    And Response body parameter should be:    [data][iso2_code]    XX
    And Response body parameter should be:    [data][iso3_code]    XXX
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PUT request:    /dynamic-entity/robottests-countries/${xaa_country_id}    {"data":{"name":"Country XXL"}}
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PUT request:    /dynamic-entity/robottests-countries    {"data":[{"id_country":${xaa_country_id},"iso2_code":"XL","iso3_code":"XXL","name":"XXL"},{"id_country":${xbb_country_id},"iso2_code":"XS","iso3_code":"XXS","name":"XXS"}]}
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a GET request:    /dynamic-entity/robottests-countries/${xbb_country_id}
    Then Response status code should be:    200
    And Response header parameter should be:    Content-Type    application/json
