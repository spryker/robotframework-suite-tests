...
Get_list_of_country_with_invalid_resource_prefix
    ...
    And I send a GET request:    /dynamic-entity-invalid/robotests-countries
...
Create_country_with_empty_data_test
    ...
    ### POST WITH EMPTY DATA ###
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a POST request:    /dynamic-entity/robotests-countries   {"data": []}
    Then Response status code should be:    400
    And Response body parameter should contain:    [0][message]    Invalid or missing data format. Please ensure that the data is provided in the correct format
    And Response body parameter should be:    [0][code]    1301
    [Teardown]    Run Keyword    Delete dynamic entity configuration in Database:    robotests-countries
...
Create_country_with_invalid_data
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a POST request:    /dynamic-entity/robotests-countries   {"data":[{"iso2_code":"XX","name":"XXX"}]}
    Then Response status code should be:    400
...
Create_country_with_invalid_field_value
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a POST request:    /dynamic-entity/robotests-countries   {"data":[{"iso2_code":"X","iso3_code":"XXXX","name":""}]}
    Then Response status code should be:    400
...
Create_country_with_invalid_field
    ...
    Delete country by iso2_code in Database:   XX
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a POST request:    /dynamic-entity/robotests-countries   {"data":[{"iso2_code":"XX","iso3_code":"XXX","name":"XXX"}]}
    Then Response status code should be:    400
...
Update_country_with_invalid_data
    ...
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a POST request:    /dynamic-entity/robotests-countries   {"data":[{"iso2_code":"XA","iso3_code":"XXA","name":"XXA"},{"iso2_code":"XB","iso3_code":"XXB","name":"XXB"}]}
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PATCH request:    /dynamic-entity/robotests-countries/${xxa_country_id}    {"data":{"iso2_code":"XXXX"}}
    Then Response status code should be:    400
    And Response body parameter should contain:    [0][message]    Invalid data value for field: iso2_code, row number: 1.
    And Response body parameter should be:    [0][code]    1306
...
Update_country_collection_with_invalid_data
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PATCH request:    /dynamic-entity/robotests-countries    {"data":[{"id_country":${xxa_country_id},"iso2_code":"XXXX"},{"id_country":${xxb_country_id},"iso3_code":"XXXXX"}]}
    Then Response status code should be:    400
    And Response body parameter should contain:    [0][message]    Invalid data value for field: iso2_code, row number: 1.
    And Response body parameter should be:    [0][code]    1306
    And Response body parameter should be:    [0][status]    400
...
Update_country_with_invalid_field_type
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PATCH request:    /dynamic-entity/robotests-countries/${xxa_country_id}    {"data":{"iso2_code":1234}}
    Then Response status code should be:    400
...
Update_country_with_invalid_field
    ...
    Delete country by iso2_code in Database:   XX
    And I set Headers:    Content-Type=application/json    Authorization=Bearer ${token}
    And I send a PATCH request:    /dynamic-entity/robotests-countries   {"data":[{"iso2_code":"XX","iso3_code":"XXX","name":"XXX"}]}
    Then Response status code should be:    400
    And Response body parameter should contain:    [0][message]    The provided `iso3_code` is incorrect or invalid.
    And Response body parameter should be:    [0][code]    1311
    And Response body parameter should contain:    [0][status]   400
...
Upsert_with_invalid_id
    ...
    And I set Headers:    Content-Type==application/json    Authorization=Bearer ${token}
    And I send a PUT request:    /dynamic-entity/robotests-countries/1000    {"data":{"iso2_code":"XX","iso3_code":"XXX","name":"Country XXX"}}
    Then Response status code should be:    400
    And Response header parameter should be:    Content-Type    application/json
