...
Create_country_with_invalid_field_value
    ...
    And Response body parameter should contain:    [0][message]    Invalid data value for field: iso2_code, row number: 1. Field rules:
    And Response body parameter should be:    [0][code]    1306
    And Response body parameter should contain:    [0][status]   400
    And Response body parameter should contain:    [1][message]    Invalid data value for field: iso3_code, row number: 1. Field rules:
    And Response body parameter should be:    [1][code]    1306
    And Response body parameter should contain:    [1][status]   400
    And Response body parameter should contain:    [2][message]    Invalid data value for field: name, row number: 1. Field rules:
...
Update_country_collection_with_invalid_data
    ...
    And Response body parameter should be:    [0][code]    1306
    And Response body parameter should be:    [0][status]    400
    And Response body parameter should contain:    [1][message]    Invalid data value for field: iso3_code, row number: 2. Field rules:
    And Response body parameter should be:    [1][code]    1306
