...
Create_country_with_invalid_data
    ...
    Then Response status code should be:    400
    And Response body parameter should contain:    [0][message]    The required field must not be empty. Field: countries.iso3_code
...
Update_country_with_invalid_field_type
    ...
    Then Response status code should be:    400
    And Response body parameter should contain:    [0][message]    Invalid data type for field: countries.iso2_code
