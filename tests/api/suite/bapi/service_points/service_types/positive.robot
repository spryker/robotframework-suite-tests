...
Get_Service_Types_List
    ...
    And Response body parameter should be in:    data[0][attributes][name]    Pickup    S_type${random}    robot    On-Site Service
    And Response body parameter should be in:    data[1][attributes][name]    Pickup    S_type${random}    robot    On-Site Service
