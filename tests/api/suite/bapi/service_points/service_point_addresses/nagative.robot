...
Create_Service_Point_Address_Without_Authentication
    ...
    When I send a POST request:    /service-points/${service_point_id}/service-point-addresses    {"data": {"type": "service-point-addresses", "attributes": {"regionUuid": "${region_uuid}", "countryIso2Code": "DE", "address": "Park Avenue", "address2": "Building №2", "zipCode": "30-221", "city": "Dreamtown"}}}
...
Create_Duplicate_Service_Point_Address
    ...
    And I send a POST request:    /service-points/${service_point_id}/service-point-addresses    {"data": {"type": "service-point-addresses", "attributes": {"regionUuid": "${region_uuid}", "countryIso2Code": "DE", "address": "Park Avenue", "address2": "Building №2", "zipCode": "30-221", "city": "Dreamtown"}}}
...
Create_Service_Point_address_without_address
    ...
    When I send a POST request:    /service-points/${service_point_id}/service-point-addresses    {"data": {"type": "service-point-addresses", "attributes": {"regionUuid": "${region_uuid}", "countryIso2Code": "DE", "address2": "Building №2", "zipCode": "30-221", "city": "Dreamtown"}}}
    Then Response status code should be:    400
...
Create_Service_Point_address_with_empty_address
    ...
    And Save value to a variable:    [data][attributes][key]    service_point_key
    And Save value to a variable:    [data][id]    service_point_id
    When I send a POST request:    /service-points/${service_point_id}/service-point-addresses    {"data": {"type": "service-point-addresses", "attributes": {"regionUuid": "${region_uuid}", "countryIso2Code": "DE", "address":"", "address2": "Building №2", "zipCode": "30-221", "city": "Dreamtown"}}}
    Then Response status code should be:    400
...
Create_Service_Point_address_with_not_existing_country
    ...
    And Save value to a variable:    [data][attributes][key]    service_point_key
    And Save value to a variable:    [data][id]    service_point_id
    When I send a POST request:    /service-points/${service_point_id}/service-point-addresses    {"data": {"type": "service-point-addresses", "attributes": {"regionUuid": "${region_uuid}", "countryIso2Code": "NOTEXIST", "address":"", "address2": "Building №2", "zipCode": "30-221", "city": "Dreamtown"}}}
    Then Response status code should be:    400
    [Teardown]    Run Keywords    Get service point uuid by key:    ${service_point_key}
    ...    AND    Delete service point in DB    ${servicePointUuid}
    # ...    AND    Delete service point address in DB    ${servicePointAddressUuid}
 ...
 Create_Service_Point_address_with_zip_more_than_15
    ...
    And Save value to a variable:    [data][attributes][key]    service_point_key
    And Save value to a variable:    [data][id]    service_point_id
    When I send a POST request:    /service-points/${service_point_id}/service-point-addresses    {"data": {"type": "service-point-addresses", "attributes": {"regionUuid": "${region_uuid}", "countryIso2Code": "DE", "address":"", "address2": "Building №2", "zipCode": "30-22111111111112", "city": "Dreamtown"}}}
    Then Response status code should be:    400
    [Teardown]    Run Keywords    Get service point uuid by key:    ${service_point_key}
    ...    AND    Delete service point in DB    ${servicePointUuid}
    # ...    AND    Delete service point address in DB    ${servicePointAddressUuid}   