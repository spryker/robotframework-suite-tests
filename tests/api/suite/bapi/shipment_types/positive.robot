...
Retrive_list_of_shipment_types_with_valid_token
    ...
    # Then Response status code should be:    200
    # And Response reason should be:    OK
    # And Each array element of array in response should contain property with NOT EMPTY value:    [data]    id
    # And Each array element of array in response should contain property with value:    [data]    type    shipment-types
    # And Each array element of array in response should contain property with NOT EMPTY value:    [data]    [attributes][name]
