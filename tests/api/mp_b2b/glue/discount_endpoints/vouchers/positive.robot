...
Adding_voucher_code_to_cart_of_logged_in_customer
    ...
    ...    AND    Response status code should be:    201
    When I send a POST request:    /carts/${cart_id}/vouchers    {"data": {"type": "vouchers","attributes": {"code": "${discount.id_4.voucher_code}"}}}
    ...
    And Response body parameter should contain:    [data][attributes][discounts][0][code]    ${discount.id_4.voucher_code}
...
Checking_voucher_is_applied_after_order_is_placed
    ...
    ...    AND    I send a POST request:    /carts/${cart_id}/items    {"data": {"type": "items","attributes": {"sku": "${discount.concrete_products_with_discounts.concrete_product_with_brand_safescan}","quantity": 2}}}
    ...    AND    Response status code should be:    201
    ...    AND    I send a POST request:    /carts/${cart_id}/vouchers    {"data": {"type": "vouchers","attributes": {"code": "${discount.id_4.voucher_code}"}}}
    ...    AND    Response status code should be:    201
    ...
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]["${discount.id_4.name}"][voucherCode]    ${discount.id_4.voucher_code}
...
Adding_two_vouchers_with_different_priority_to_the_same_cart
    ...
    And Response body parameter should contain:    [data][attributes][discounts][1][code]    ${discount.id_3.voucher_code}
    [Teardown]    Run Keywords    I send a DELETE request:    /carts/${cart_id}
    ...  AND    Response status code should be:    204
...
Deleting_voucher_from_cart_of_logged_in_customer
    ...
    ...    AND    I send a POST request:    /carts/${cart_id}/vouchers    {"data": {"type": "vouchers","attributes": {"code": "${discount.id_4.voucher_code}"}}}
    ...    AND    Response status code should be:    201
    When I send a DELETE request:    /carts/${cartId}/vouchers/${discount.id_4.voucher_code}
    ...
    And Response body parameter should NOT be:    [data][attributes][discounts][0][code]    ${discount.id_4.voucher_code}
    [Teardown]    Run Keywords    I send a DELETE request:    /carts/${cart_id}
    ...  AND    Response status code should be:    204