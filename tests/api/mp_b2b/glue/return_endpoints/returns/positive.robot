...
Create_a_return
    ...
    ...  AND    I send a POST request:    /carts/${cartId}/items    {"data": {"type": "items","attributes": {"sku": "${concrete_product_with_offer_sku}","quantity": 1, "merchantReference" : "${merchant_id}", "productOfferReference" : "${merchant_offer_id}"}}}
