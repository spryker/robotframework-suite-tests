...
Cart_contains_product_with_upselling_relation_with_include_category_nodes
    ...
    And Response body parameter should be:    [data][0][relationships][category-nodes][data][0][id]    ${concrete_of_product_with_relations_upselling.category_nodes.category_node_26.id}
    And Response body parameter should be:    [data][0][relationships][category-nodes][data][1][id]    ${concrete_of_product_with_relations_upselling.category_nodes.category_node_24.id}
    And Each array element of array in response should contain property:    [included]    id
    And Each array element of array in response should contain property:    [included]    attributes
    And Each array element of array in response should contain property:    [included]    links
    ...
    And Response body parameter should be:    [included][0][id]    ${concrete_of_product_with_relations_upselling.category_nodes.category_node_26.id}
    And Response body parameter should be:    [included][0][attributes][name]    ${concrete_of_product_with_relations_upselling.category_nodes.category_node_26.name}
    And Response body parameter should be:    [included][1][id]    ${concrete_of_product_with_relations_upselling.category_nodes.category_node_24.id}
    And Response body parameter should be:    [included][1][attributes][name]    ${concrete_of_product_with_relations_upselling.category_nodes.category_node_24.name}
    [Teardown]    Run Keywords    I send a DELETE request:    /carts/${cart_id}
    ...  AND    Response status code should be:    204
