...
Create_order_include_orders
    ...
    #items
    And Response body parameter should be:    [included][0][attributes][items][0][name]    ${concrete.available_product.with_stock_and_never_out_of_stock.name}
    And Response body parameter should be:    [included][0][attributes][items][0][sku]    ${concrete.available_product.with_stock_and_never_out_of_stock.sku}
...
Create_order_with_weight_product_&_product_options
    ...
    And Response body parameter should be:    [included][0][attributes][items][0][quantity]    1
    #product_2
    And Response body parameter should be:    [included][0][attributes][items][1][name]    ${concrete.with_options.name}
    ...
    #product_3
    And Response body parameter should be:    [included][0][attributes][items][2][name]    ${concrete.random_weight.name}
    ...
    And Response body parameter should be:    [included][0][attributes][items][2][salesUnit][productMeasurementUnit][name]    ${packaging_unit.m_name}
    And Response body parameter should be:    [included][0][attributes][items][2][salesUnit][productMeasurementUnit][code]    ${packaging_unit.m}
    And Response body has correct self link internal
...
Create_order_with_same_items_in_different_shipments
    ...
    ...  AND    Save value to a variable:    [data][id]    cart_id
    ...  AND    I send a POST request:    /carts/${cartId}/items    {"data": {"type": "items","attributes": {"sku": "${concrete.available_product.with_stock_and_never_out_of_stock.sku}","quantity": 1}}}
    When I send a POST request:    /checkout?include=orders    {"data": {"type": "checkout","attributes": {"customer": {"salutation": "${yves_user.salutation}","email": "${yves_user.email}","firstName": "${yves_user.first_name}","lastName": "${yves_user.last_name}"},"idCart": "${cart_id}","billingAddress": {"salutation": "${yves_user.salutation}","firstName": "${yves_user.first_name}","lastName": "${yves_user.last_name}","address1": "${default.address1}","address2": "${default.address2}","address3": "${default.address3}","zipCode": "${default.zipCode}","city": "${default.city}","iso2Code": "${default.iso2Code}","company": "${default.company}","phone": "${default.phone}","isDefaultBilling": False,"isDefaultShipping": False},"payments": [{"paymentMethodName": "${payment_method_name}","paymentProviderName": "${payment_provider_name}"}],"shipments": [{"items": ["${concrete.available_product.with_stock_and_never_out_of_stock.sku}"],"shippingAddress": {"salutation": "${yves_user.salutation}","firstName": "${yves_user.first_name}","lastName": "${yves_user.last_name}","address1": "${default.address1}","address2": "${default.address2}","address3": "${default.address3}","zipCode": "${default.zipCode}","city": "${default.city}","iso2Code": "${default.iso2Code}","company": "${default.company}","phone": "${default.phone}"},"idShipmentMethod": 2,"requestedDeliveryDate": None},{"items": ["${concrete.available_product.with_stock_and_never_out_of_stock.sku}"],"shippingAddress": {"salutation": "${yves_user.salutation}","firstName": "${yves_user.first_name}","lastName": "${yves_user.last_name}","address1": "${changed.address1}","address2": "${changed.address2}","address3": "${changed.address3}","zipCode": "${default.zipCode}","city": "${default.city}","iso2Code": "${default.iso2Code}","company": "${default.company}","phone": "${changed.phone}","isDefaultBilling": False,"isDefaultShipping": False},"idShipmentMethod": 1,"requestedDeliveryDate": None}]}}}
    Then Response status code should be:    201
    And Response reason should be:    Created
    And Response body parameter should be:    [data][type]    checkout
    And Response body parameter should be:    [data][id]    None
...
Create_order_with_free_shipping_discount
    ...
    And Response body parameter should be:    [data][type]    checkout
    And Response body parameter should be:    [data][id]    None
    And Response body parameter should be:    [included][0][attributes][totals][expenseTotal]    ${discounts.discount_3.total_sum}
    And Response body parameter should be greater than:    [included][0][attributes][totals][discountTotal]    0
    And Response body parameter should be greater than:    [included][0][attributes][totals][taxTotal]    0
    ...
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]["Free standard delivery"][unitAmount]     None
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]["Free standard delivery"][sumAmount]     ${discounts.discount_3.total_sum}
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]["Free standard delivery"][displayName]     ${discounts.discount_3.name}
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]["Free standard delivery"][description]     ${discounts.discount_3.description}
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]["Free standard delivery"][voucherCode]     None
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]["Free standard delivery"][quantity]     1
...
Create_order_with_2_product_discounts
    ...
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][0][unitAmount]    ${discount.product_1.with_discount_20_percent_off_storage}
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][0][sumAmount]    ${discount.product_1.with_discount_20_percent_off_storage}
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][0][displayName]    ${discounts.discount_1.name}
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][0][description]    ${discounts.discount_1.description}
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][0][voucherCode]    None
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][0][quantity]    1
    #item 1 - "10% off minimum order" discount
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][1][unitAmount]    ${discount.product_1.with_discount_10_percent_off_minimum_order}
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][1][sumAmount]    ${discount.product_1.with_discount_10_percent_off_minimum_order}
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][1][displayName]    ${discounts.discount_2.name}
    And Response body parameter should be:    [included][0][attributes][items][0][calculatedDiscounts][1][description]    ${discounts.discount_2.description}
    ...
    And Response body parameter should be:    [included][0][attributes][items][1][calculatedDiscounts][0][unitAmount]    ${discount.product_2.with_discount_20_percent_off_storage}
    And Response body parameter should be:    [included][0][attributes][items][1][calculatedDiscounts][0][sumAmount]    ${discount.product_2.with_discount_20_percent_off_storage}
    And Response body parameter should be:    [included][0][attributes][items][1][calculatedDiscounts][0][displayName]    ${discounts.discount_1.name}
    And Response body parameter should be:    [included][0][attributes][items][1][calculatedDiscounts][0][description]    ${discounts.discount_1.description}
    ...
    And Response body parameter should be:    [included][0][attributes][items][1][calculatedDiscounts][1][unitAmount]    ${discount.product_2.with_discount_10_percent_off_minimum_order}
    And Response body parameter should be:    [included][0][attributes][items][1][calculatedDiscounts][1][sumAmount]    ${discount.product_2.with_discount_10_percent_off_minimum_order}
    And Response body parameter should be:    [included][0][attributes][items][1][calculatedDiscounts][1][displayName]    ${discounts.discount_2.name}
    And Response body parameter should be:    [included][0][attributes][items][1][calculatedDiscounts][1][description]    ${discounts.discount_2.description}
    ...
    And Response body parameter should be:    [included][0][attributes][items][2][calculatedDiscounts][0][unitAmount]    ${discount.product_3.with_10_percent_discount_amount}
    And Response body parameter should be:    [included][0][attributes][items][2][calculatedDiscounts][0][sumAmount]    ${discount.product_3.with_10_percent_discount_amount}
    And Response body parameter should be:    [included][0][attributes][items][2][calculatedDiscounts][0][displayName]    ${discounts.discount_2.name}
    And Response body parameter should be:    [included][0][attributes][items][2][calculatedDiscounts][0][description]    ${discounts.discount_2.description}
    ...
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    sumAmount: ${discounts.discount_1.total_sum_for_products_1_and_2}
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    displayName: ${discounts.discount_1.name}
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    description: ${discounts.discount_1.description}
    ...
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    unitAmount: None
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    sumAmount: ${discounts.discount_2.total_sum_for_discounts_for_products_1_2_and_3}
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    displayName: ${discounts.discount_2.name}
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    description: ${discounts.discount_2.description}
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    voucherCode: None
    And Response body parameter should contain:    [included][0][attributes][calculatedDiscounts]    quantity: 3