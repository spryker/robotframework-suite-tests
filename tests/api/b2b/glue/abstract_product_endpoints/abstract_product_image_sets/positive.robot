...
Abstract_image_sets_with_1_concrete
    When I send a GET request:    /abstract-products/${abstract.available_products.with_stock_and_never_out_of_stock_sku}/abstract-product-image-sets
...
Abstract_image_sets_with_3_concretes
    When I send a GET request:    /abstract-products/${abstract.available_products.with_3_concretes.sku}/abstract-product-image-sets
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
