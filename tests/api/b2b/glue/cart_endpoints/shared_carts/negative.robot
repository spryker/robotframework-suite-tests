...
Share_shopping_cart_without_permission_group_attribute
    ...
    ...    AND    I send a GET request:    /company-users
    ...    AND    Save value to a variable:    [data][0][id]    companyUserId
    When I send a POST request:    /carts/${cartId}/shared-carts    {"data":{"type":"shared-carts","attributes":{"idCompanyUser":"${companyUserId}"}}}
    Then Response status code should be:    422
    And Response should return error code:    901
    And Response reason should be:    Unprocessable Content
...
Share_shopping_cart_with_empty_type
    ...
    ...    AND    I send a GET request:    /company-users
    ...    AND    Save value to a variable:    [data][0][id]    companyUserId
    When I send a POST request:    /carts/${cartId}/shared-carts    {"data":{"type":"","attributes":{"idCompanyUser":"${companyUserId}","idCartPermissionGroup":1}}}
...
Share_shopping_cart_with_wrong_type
    ...
    ...    AND    I send a GET request:    /company-users
    ...    AND    Save value to a variable:    [data][0][id]    companyUserId
    When I send a POST request:    /carts/${cartId}/shared-carts    {"data":{"type":"sharedcarts","attributes":{"idCompanyUser":"${companyUserId}","idCartPermissionGroup":1}}}
    Then Response status code should be:    400
    And Response reason should be:    Bad Request
    And Response should return error message:    Invalid type.
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
...
Share_shopping_cart_without_type
    ...
    ...    AND    I send a GET request:    /company-users
    ...    AND    Save value to a variable:    [data][0][id]    companyUserId
    When I send a POST request:    /carts/${cartId}/shared-carts    {"data":{"attributes":{"idCompanyUser":"${companyUserId}","idCartPermissionGroup":1}}}
    Then Response status code should be:    400
    And Response reason should be:    Bad Request
    And Response should return error message:    Post data is invalid.
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
...
Update_permissions_of_shared_shopping_cart_with_empty_request_body
    ...
    ...    AND    I send a POST request:    /carts/${cartId}/shared-carts    {"data":{"type":"shared-carts","attributes":{"idCompanyUser":"${companyUserId}","idCartPermissionGroup":2}}}
    ...    AND    Save value to a variable:    [data][id]    sharedCardId
    When I send a PATCH request:    /shared-carts/${sharedCardId}    {}
    Then Response status code should be:    400
    And Response reason should be:    Bad Request
    And Response should return error message:    Post data is invalid.
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
...
Update_permissions_of_shared_shopping_cart_with_empty_type
    ...
    ...    AND    I send a POST request:    /carts/${cartId}/shared-carts    {"data":{"type":"shared-carts","attributes":{"idCompanyUser":"${companyUserId}","idCartPermissionGroup":2}}}
    ...    AND    Save value to a variable:    [data][id]    sharedCardId
    When I send a PATCH request:    /shared-carts/${sharedCardId}    {"data":{"type":"","attributes":{"idCartPermissionGroup":1}}}
    Then Response status code should be:    400
    And Response reason should be:    Bad Request
    And Response should return error message:    Invalid type.
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
...
Update_permissions_of_shared_shopping_cart_with_wrong_type
    ...
    ...    AND    I send a POST request:    /carts/${cartId}/shared-carts    {"data":{"type":"shared-carts","attributes":{"idCompanyUser":"${companyUserId}","idCartPermissionGroup":2}}}
    ...    AND    Save value to a variable:    [data][id]    sharedCardId
    When I send a PATCH request:    /shared-carts/${sharedCardId}    {"data":{"type":"sharedcarts","attributes":{"idCartPermissionGroup":1}}}
    Then Response status code should be:    400
    And Response reason should be:    Bad Request
    And Response should return error message:    Invalid type.
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
...
Update_permissions_of_shared_shopping_cart_without_type
    ...
    ...    AND    I send a POST request:    /carts/${cartId}/shared-carts    {"data":{"type":"shared-carts","attributes":{"idCompanyUser":"${companyUserId}","idCartPermissionGroup":2}}}
    ...    AND    Save value to a variable:    [data][id]    sharedCardId
    When I send a PATCH request:    /shared-carts/${sharedCardId}    {"data":{"attributes":{"idCartPermissionGroup":1}}}
    Then Response status code should be:    400
    And Response reason should be:    Bad Request
    And Response should return error message:    Post data is invalid.
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
...
Update_an_item_quantity_at_the_shared_shopping_cart_by_user_without_access
    ...
    When I send a PATCH request:    /carts/${cartId}/items/${itemId}    {"data":{"type":"items","attributes":{"quantity":2}}}
    Then Response status code should be:    403
    And Response should return error code:    115
    And Response reason should be:    Forbidden
    And Response should return error message:    Unauthorized cart action.
