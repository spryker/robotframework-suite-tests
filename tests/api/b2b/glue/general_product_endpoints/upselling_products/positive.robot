...
Get_upselling_products
    ...
    And Response body parameter should be:    [data][0][id]    ${abstract.product_with_relations.has_related_products.has_upselling_product.sku}
    And Response body parameter should not be EMPTY:    [data][0][attributes]
    And Response body parameter should be:    [data][0][attributes][sku]    ${abstract.product_with_relations.has_related_products.has_upselling_product.sku}
    ...
    And Response body parameter should be:    [data][0][attributes][name]    ${abstract.product_with_relations.has_related_products.has_upselling_product.name}
