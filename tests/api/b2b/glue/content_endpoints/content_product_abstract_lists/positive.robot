...
Abstract_product_list_abstract_products
    ...
    And Response body parameter should be:    [data][0][attributes][name]    ${abstract_list_product1_name}
    And Response body parameter should be:    [data][1][attributes][sku]    ${abstract_list_product2_sku}
    And Response body parameter should be:    [data][1][attributes][name]    ${abstract_list_product2_name}

# there is a bug in b2b - include does not work
Abstract_product_list_with_include
    ...
    And Response body parameter should be:    [data][type]    content-product-abstract-lists
    And Response body has correct self link internal
    And Response should contain the array of a certain size:    [data][relationships][abstract-products][data]    ${abstract_list_size}
    And Response should contain the array of a certain size:    [included]    ${abstract_list_size}
