...
Get_concrete_bundled_products_inside_concrete_bundle
    ...
    And Response body parameter should be in:    [data][1][attributes][sku]    ${bundle_product.product_2.concrete_sku}    ${bundle_product.product_3.concrete_sku}
    And Response body parameter should be in:    [data][2][attributes][sku]    ${bundle_product.product_2.concrete_sku}    ${bundle_product.product_3.concrete_sku}
