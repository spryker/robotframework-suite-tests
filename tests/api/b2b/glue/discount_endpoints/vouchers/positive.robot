...
Checking_voucher_is_applied_after_order_is_placed
    ...
    ...    AND    Save value to a variable:    [data][id]    cart_id
    ...    AND    Response status code should be:    201
    ...    AND    I send a POST request:    /carts/${cart_id}/items?include=items    {"data": {"type": "items","attributes": {"sku": "${concrete.with_brand_safescan.product_1.sku}","quantity": 2}}}
    ...    AND    Response status code should be:    201
