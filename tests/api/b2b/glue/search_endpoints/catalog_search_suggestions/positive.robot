...
Get_search_suggestions_with_discontinued_product_sku
    ...
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    And Response body parameter should be:    [data][0][attributes][completion]    ${concrete.alternative_products.product_1.sku}
    And Response should contain the array of a certain size:    [data][0][attributes][categories]    0
    And Response should contain the array of a certain size:    [data][0][attributes][cmsPages]    0
...
Get_search_suggestions_with_all_attributes_data
    ...
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    And Response body parameter should be:    [data][0][attributes][completion]    ${concrete.alternative_products.product_1.name_in_lower_case}
...
Get_search_suggestions_with_abstract_product_sku
    ...
    And Response body parameter should be:    [data][0][id]    None
    And Response body parameter should be greater than:    [data][0][attributes][abstractProducts][0][price]    0
    And Response body parameter should be:    [data][0][attributes][abstractProducts][0][abstractName]    ${abstract.available_products.with_stock.name}
    And Response body parameter should be:    [data][0][attributes][abstractProducts][0][abstractSku]    ${abstract.available_products.with_stock.sku}
    And Response body parameter should not be EMPTY:    [data][0][attributes][abstractProducts][0][url]
...
Get_search_suggestions_with_category_collection
    ...
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    And Response body parameter should be:    [data][0][attributes][categoryCollection][0][name]    ${category_collection.name}
    And Response body parameter should be:    [data][0][attributes][categoryCollection][0][url]    ${category_collection.url}
    And Response body has correct self link
...
Get_search_suggestions_with_cms_page_collection
    ...
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    And Response body parameter should be:    [data][0][attributes][cmsPageCollection][0][name]    ${cms_page.collection_name}
    And Response body parameter should be:    [data][0][attributes][cmsPageCollection][0][url]    ${cms_page.collection_url}
    And Response body has correct self link
...
Get_search_suggestions_with_brand_and_currency
    ...
    And Response should contain the array of a certain size:    [data][0][attributes][completion]    10
    And Response should contain the array of a certain size:    [data][0][attributes][abstractProducts]    10
    And Response body parameter should be:    [data][0][attributes][abstractProducts][8][price]    ${abstract.alternative_products.product_2.price_chf}
    And Response body has correct self link
...
Get_search_suggestions_with_abstract_product_sku_and_included_abstract_products
    When I send a GET request:    /catalog-search-suggestions?q=${abstract.available_products.with_stock.sku}&include=abstract-products
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response body parameter should be:    [data][0][type]    catalog-search-suggestions
    And Response body parameter should be:    [data][0][id]    None
    ...
    And Response body parameter should be:    [data][0][relationships][abstract-products][data][0][id]    ${abstract.available_products.with_stock.sku}
    ...
    And Response body parameter should be:    [included][0][attributes][sku]    ${abstract.available_products.with_stock.sku}
