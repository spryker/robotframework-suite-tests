...
Get_navigation_tree_using_valid_navigation_key
    When I send a GET request:    /navigations/SOCIAL_LINKS
    Then Response status code should be:    200
    And Response reason should be:    OK
    And Response header parameter should be:    Content-Type    ${default_header_content_type}
    And Response body parameter should be:    [data][type]    navigations
    And Response body parameter should be:    [data][id]    SOCIAL_LINKS
    ...
    And Response Body parameter should have datatype:    [data][attributes][nodes][0][url]    str
