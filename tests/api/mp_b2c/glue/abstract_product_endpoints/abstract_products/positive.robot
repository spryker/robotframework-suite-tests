...
Abstract_product_with_one_concrete
    ...
    And Response body parameter should contain:    [data][attributes][superAttributesDefinition]    ${abstract_available_product_with_stock_superAttributesDefinition}
...
Abstract_product_with_abstract_includes_for_reviews
    ...
    And Response body parameter should be:    [data][attributes][name]    ${abstract_product_with_review_name}
    And Response body has correct self link internal
