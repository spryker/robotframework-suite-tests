...
Assign_user_to_warehouse_with_include
    ...
    And Response body parameter should be:    [included][0][attributes][username]    ${warehous_user[0].admin_user_name}
    And Response body parameter should be:    [included][0][attributes][firstName]    ${warehous_user[0].admin_user_first_name}
    And Response body parameter should be:    [included][0][attributes][lastName]    ${warehous_user[0].admin_user_last_name}
    [Teardown]     Run Keywords    I send a DELETE request:    /warehouse-user-assignments/${warehouse_assigment_id}
    ...    AND    Response status code should be:    204
    ...    AND    Make user a warehouse user/ not a warehouse user:   ${warehous_user[0].admin_user_uuid}    0
...
Get_warehouse_user_assigments_list
    ...
    And Response body parameter should be:    [data][1][attributes][userUuid]    ${warehous_user[0].admin_user_uuid}
...
Get_warehouse_user_assigments_with_filter_by_warehouse_uuid
    ...
    And Response body parameter should be:    [data][0][attributes][userUuid]    ${warehous_user[0].de_admin_user_uuid}
...
Update_warehous_user_assigment
 ...
 Create_warehouse_user_assignment_with_multiple_active_assignments
    ...
    Then I send a GET request:    /warehouse-user-assignments/${warehouse_assigment_id}
    And Response body parameter should be:    [data][attributes][isActive]    True
    When I send a POST request:    /warehouse-user-assignments    {"data": {"type": "warehouse-user-assignments", "attributes":{"userUuid": "${warehous_user[0].admin_user_uuid}","warehouse" :{"uuid": "${warehouse[0].video_king_warehouse_uuid}"},"isActive":"true"}}}
    Then Save value to a variable:    [data][id]   warehouse_assigment_id_2
